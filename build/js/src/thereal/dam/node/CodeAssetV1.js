...
const M = CodeAssetV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:node:code-asset:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:node:code-asset';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:node:code-asset:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:ncr:mixin:node:v1',
  'gdbots:ncr:mixin:node',
  'triniti:dam:mixin:asset:v1',
  'triniti:dam:mixin:asset',
  'triniti:dam:mixin:code-asset:v1',
