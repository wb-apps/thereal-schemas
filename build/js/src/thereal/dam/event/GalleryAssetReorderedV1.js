...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:event:gallery-asset-reordered:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:event:gallery-asset-reordered';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:event:gallery-asset-reordered:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:event:v1',
  'gdbots:pbjx:mixin:event',
  'triniti:dam:mixin:gallery-asset-reordered:v1',
