...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:event:asset-patched:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:event:asset-patched';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-patched:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:event:v1',
  'gdbots:pbjx:mixin:event',
  'gdbots:ncr:mixin:node-patched:v1',
  'gdbots:ncr:mixin:node-patched',
  'triniti:dam:mixin:asset-patched:v1',
