...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:command:patch-assets:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:command:patch-assets';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:command:patch-assets:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:patch-nodes:v1',
  'gdbots:ncr:mixin:patch-nodes',
  'triniti:dam:mixin:patch-assets:v1',
