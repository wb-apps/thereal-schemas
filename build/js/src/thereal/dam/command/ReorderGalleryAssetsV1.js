...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:command:reorder-gallery-assets:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:command:reorder-gallery-assets';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:command:reorder-gallery-assets:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'triniti:dam:mixin:reorder-gallery-assets:v1',
