...
const M = GetAssetResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:request:get-asset-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:request:get-asset-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-asset-response:v1';
