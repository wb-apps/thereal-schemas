...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:dam:request:get-upload-urls-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:dam:request:get-upload-urls-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-upload-urls-request:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:request:v1',
  'gdbots:pbjx:mixin:request',
  'triniti:dam:mixin:get-upload-urls-request:v1',
