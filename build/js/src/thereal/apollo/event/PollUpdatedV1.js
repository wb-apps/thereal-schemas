// @link https://schemas.thereal.com/json-schema/thereal/apollo/event/poll-updated/1-0-0.json#
...
export default class PollUpdatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = PollUpdatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:apollo:event:poll-updated:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:apollo:event:poll-updated';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-updated:v1';
