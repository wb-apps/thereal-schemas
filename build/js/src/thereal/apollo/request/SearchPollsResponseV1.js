...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:apollo:request:search-polls-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:apollo:request:search-polls-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:apollo:request:search-polls-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  ...
  'triniti:apollo:mixin:search-polls-response:v1',
