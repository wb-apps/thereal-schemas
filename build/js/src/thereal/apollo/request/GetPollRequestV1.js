...
export default class GetPollRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:apollo:request:get-poll-request:1-0-0', GetPollRequestV1,
      [],
      [
...
MessageResolver.register('thereal:apollo:request:get-poll-request', GetPollRequestV1);
