...
const M = UpdatePollV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:apollo:command:update-poll:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:apollo:command:update-poll';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:update-poll:v1';
