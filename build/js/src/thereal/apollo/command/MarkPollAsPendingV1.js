...
const M = MarkPollAsPendingV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:apollo:command:mark-poll-as-pending:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:apollo:command:mark-poll-as-pending';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:mark-poll-as-pending:v1';
