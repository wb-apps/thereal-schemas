...
const M = ExpirePollV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:apollo:command:expire-poll:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:apollo:command:expire-poll';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:expire-poll:v1';
