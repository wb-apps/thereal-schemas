// @link https://schemas.thereal.com/json-schema/thereal/people/request/get-person-history-request/1-0-0.json#
...
export default class GetPersonHistoryRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetPersonHistoryRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:people:request:get-person-history-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:people:request:get-person-history-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:people:request:get-person-history-request:v1';
