...
const M = UpdatePersonV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:people:command:update-person:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:people:command:update-person';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:people:command:update-person:v1';
