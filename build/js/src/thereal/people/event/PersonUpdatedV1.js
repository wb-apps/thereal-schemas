...
export default class PersonUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:people:event:person-updated:1-0-0', PersonUpdatedV1,
      [],
      [
...
MessageResolver.register('thereal:people:event:person-updated', PersonUpdatedV1);
