...
export default class TeaserUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:event:teaser-unpublished:1-0-0', TeaserUnpublishedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(TeaserUnpublishedV1);
MessageResolver.register('thereal:curator:event:teaser-unpublished', TeaserUnpublishedV1);
Object.freeze(TeaserUnpublishedV1);
Object.freeze(TeaserUnpublishedV1.prototype);
