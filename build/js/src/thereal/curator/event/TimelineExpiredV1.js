...
export default class TimelineExpiredV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = TimelineExpiredV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:timeline-expired:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:timeline-expired';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-expired:v1';
