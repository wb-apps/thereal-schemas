// @link https://schemas.thereal.com/json-schema/thereal/curator/event/gallery-deleted/1-0-0.json#
...
export default class GalleryDeletedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GalleryDeletedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:gallery-deleted:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:gallery-deleted';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-deleted:v1';
