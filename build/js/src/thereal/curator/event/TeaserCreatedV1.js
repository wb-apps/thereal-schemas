// @link https://schemas.thereal.com/json-schema/thereal/curator/event/teaser-created/1-0-0.json#
...
export default class TeaserCreatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = TeaserCreatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:teaser-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:teaser-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-created:v1';
