// @link https://schemas.thereal.com/json-schema/thereal/curator/event/gallery-scheduled/1-0-0.json#
...
export default class GalleryScheduledV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:event:gallery-scheduled:1-0-0', GalleryScheduledV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(GalleryScheduledV1);
MessageResolver.register('thereal:curator:event:gallery-scheduled', GalleryScheduledV1);
Object.freeze(GalleryScheduledV1);
Object.freeze(GalleryScheduledV1.prototype);
