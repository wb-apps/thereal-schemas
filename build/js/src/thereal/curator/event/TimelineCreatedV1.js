...
export default class TimelineCreatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = TimelineCreatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:timeline-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:timeline-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-created:v1';
