...
export default class GalleryPublishedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:event:gallery-published:1-0-0', GalleryPublishedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(GalleryPublishedV1);
MessageResolver.register('thereal:curator:event:gallery-published', GalleryPublishedV1);
Object.freeze(GalleryPublishedV1);
Object.freeze(GalleryPublishedV1.prototype);
