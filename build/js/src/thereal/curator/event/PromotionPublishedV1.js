// @link https://schemas.thereal.com/json-schema/thereal/curator/event/promotion-published/1-0-0.json#
...
export default class PromotionPublishedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:event:promotion-published:1-0-0', PromotionPublishedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(PromotionPublishedV1);
MessageResolver.register('thereal:curator:event:promotion-published', PromotionPublishedV1);
Object.freeze(PromotionPublishedV1);
Object.freeze(PromotionPublishedV1.prototype);
