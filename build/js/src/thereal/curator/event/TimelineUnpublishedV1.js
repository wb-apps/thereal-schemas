...
export default class TimelineUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:event:timeline-unpublished:1-0-0', TimelineUnpublishedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(TimelineUnpublishedV1);
MessageResolver.register('thereal:curator:event:timeline-unpublished', TimelineUnpublishedV1);
Object.freeze(TimelineUnpublishedV1);
Object.freeze(TimelineUnpublishedV1.prototype);
