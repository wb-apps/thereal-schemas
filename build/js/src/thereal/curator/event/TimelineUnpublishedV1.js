// @link https://schemas.thereal.com/json-schema/thereal/curator/event/timeline-unpublished/1-0-0.json#
...
export default class TimelineUnpublishedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = TimelineUnpublishedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:timeline-unpublished:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:timeline-unpublished';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-unpublished:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:event:v1',
  'gdbots:pbjx:mixin:event',
  'gdbots:ncr:mixin:node-unpublished:v1',
