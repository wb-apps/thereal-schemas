...
export default class GalleryRenamedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GalleryRenamedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:gallery-renamed:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:gallery-renamed';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-renamed:v1';
