// @link https://schemas.thereal.com/json-schema/thereal/curator/event/widget-created/1-0-0.json#
...
export default class WidgetCreatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = WidgetCreatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:event:widget-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:event:widget-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:event:widget-created:v1';
