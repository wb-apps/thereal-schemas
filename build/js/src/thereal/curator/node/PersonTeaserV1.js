// @link https://schemas.thereal.com/json-schema/thereal/curator/node/person-teaser/1-0-0.json#
...
import TrinitiCuratorPersonTeaserV1Mixin from '@triniti/schemas/triniti/curator/mixin/person-teaser/PersonTeaserV1Mixin';
import TrinitiCuratorPersonTeaserV1Trait from '@triniti/schemas/triniti/curator/mixin/person-teaser/PersonTeaserV1Trait';
...
export default class PersonTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:person-teaser:1-0-0', PersonTeaserV1,
      [],
      [
...
GdbotsNcrNodeV1Trait(PersonTeaserV1);
TrinitiCuratorPersonTeaserV1Trait(PersonTeaserV1);
MessageResolver.register('thereal:curator:node:person-teaser', PersonTeaserV1);
Object.freeze(PersonTeaserV1);
Object.freeze(PersonTeaserV1.prototype);
