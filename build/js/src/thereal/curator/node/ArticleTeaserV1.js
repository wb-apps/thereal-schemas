// @link https://schemas.thereal.com/json-schema/thereal/curator/node/article-teaser/1-0-0.json#
...
import TrinitiCuratorArticleTeaserV1Mixin from '@triniti/schemas/triniti/curator/mixin/article-teaser/ArticleTeaserV1Mixin';
import TrinitiCuratorArticleTeaserV1Trait from '@triniti/schemas/triniti/curator/mixin/article-teaser/ArticleTeaserV1Trait';
...
export default class ArticleTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
        GdbotsNcrNodeV1Mixin.create(),
        TrinitiCuratorTeaserV1Mixin.create(),
        TrinitiCuratorTeaserHasTargetV1Mixin.create(),
        TrinitiCuratorArticleTeaserV1Mixin.create(),
...
GdbotsNcrNodeV1Trait(ArticleTeaserV1);
TrinitiCuratorArticleTeaserV1Trait(ArticleTeaserV1);
MessageResolver.register('thereal:curator:node:article-teaser', ArticleTeaserV1);
Object.freeze(ArticleTeaserV1);
Object.freeze(ArticleTeaserV1.prototype);
