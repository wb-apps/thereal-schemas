// @link https://schemas.thereal.com/json-schema/thereal/curator/node/category-teaser/1-0-0.json#
...
export default class CategoryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:category-teaser:1-0-0', CategoryTeaserV1,
      [],
      [
...
MessageResolver.register('thereal:curator:node:category-teaser', CategoryTeaserV1);
