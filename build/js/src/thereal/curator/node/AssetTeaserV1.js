// @link https://schemas.thereal.com/json-schema/thereal/curator/node/asset-teaser/1-0-0.json#
...
import TrinitiCuratorAssetTeaserV1Mixin from '@triniti/schemas/triniti/curator/mixin/asset-teaser/AssetTeaserV1Mixin';
import TrinitiCuratorAssetTeaserV1Trait from '@triniti/schemas/triniti/curator/mixin/asset-teaser/AssetTeaserV1Trait';
...
export default class AssetTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:asset-teaser:1-0-0', AssetTeaserV1,
      [],
      [
        GdbotsNcrNodeV1Mixin.create(),
        TrinitiCuratorTeaserV1Mixin.create(),
        TrinitiCuratorTeaserHasTargetV1Mixin.create(),
        TrinitiCuratorAssetTeaserV1Mixin.create(),
...
GdbotsNcrNodeV1Trait(AssetTeaserV1);
TrinitiCuratorAssetTeaserV1Trait(AssetTeaserV1);
MessageResolver.register('thereal:curator:node:asset-teaser', AssetTeaserV1);
Object.freeze(AssetTeaserV1);
Object.freeze(AssetTeaserV1.prototype);
