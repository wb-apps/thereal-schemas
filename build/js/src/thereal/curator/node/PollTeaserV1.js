// @link https://schemas.thereal.com/json-schema/thereal/curator/node/poll-teaser/1-0-0.json#
...
import TrinitiCuratorPollTeaserV1Mixin from '@triniti/schemas/triniti/curator/mixin/poll-teaser/PollTeaserV1Mixin';
import TrinitiCuratorPollTeaserV1Trait from '@triniti/schemas/triniti/curator/mixin/poll-teaser/PollTeaserV1Trait';
...
export default class PollTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:poll-teaser:1-0-0', PollTeaserV1,
      [],
      [
        GdbotsNcrNodeV1Mixin.create(),
        TrinitiCuratorTeaserV1Mixin.create(),
        TrinitiCuratorTeaserHasTargetV1Mixin.create(),
        TrinitiCuratorPollTeaserV1Mixin.create(),
...
GdbotsNcrNodeV1Trait(PollTeaserV1);
TrinitiCuratorPollTeaserV1Trait(PollTeaserV1);
MessageResolver.register('thereal:curator:node:poll-teaser', PollTeaserV1);
Object.freeze(PollTeaserV1);
Object.freeze(PollTeaserV1.prototype);
