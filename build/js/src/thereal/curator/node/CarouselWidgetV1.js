...
export default class CarouselWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:carousel-widget:1-0-0', CarouselWidgetV1,
      [],
      [
...
MessageResolver.register('thereal:curator:node:carousel-widget', CarouselWidgetV1);
