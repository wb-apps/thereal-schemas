...
export default class PageTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
GdbotsNcrNodeV1Trait(PageTeaserV1);
TrinitiCuratorPageTeaserV1Trait(PageTeaserV1);
MessageResolver.register('thereal:curator:node:page-teaser', PageTeaserV1);
Object.freeze(PageTeaserV1);
Object.freeze(PageTeaserV1.prototype);
