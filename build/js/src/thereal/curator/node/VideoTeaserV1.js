// @link https://schemas.thereal.com/json-schema/thereal/curator/node/video-teaser/1-0-0.json#
...
export default class VideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:node:video-teaser:1-0-0', VideoTeaserV1,
      [],
      [
...
MessageResolver.register('thereal:curator:node:video-teaser', VideoTeaserV1);
