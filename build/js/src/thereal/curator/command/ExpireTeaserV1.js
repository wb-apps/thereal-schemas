// @link https://schemas.thereal.com/json-schema/thereal/curator/command/expire-teaser/1-0-0.json#
...
export default class ExpireTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ExpireTeaserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:command:expire-teaser:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:command:expire-teaser';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:command:expire-teaser:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:expire-node:v1',
