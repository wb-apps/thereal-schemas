...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:command:sync-teaser:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:command:sync-teaser';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:command:sync-teaser:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'triniti:curator:mixin:sync-teaser:v1',
