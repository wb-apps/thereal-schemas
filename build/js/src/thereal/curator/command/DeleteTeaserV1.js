// @link https://schemas.thereal.com/json-schema/thereal/curator/command/delete-teaser/1-0-0.json#
...
export default class DeleteTeaserV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = DeleteTeaserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:command:delete-teaser:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:command:delete-teaser';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-teaser:v1';
