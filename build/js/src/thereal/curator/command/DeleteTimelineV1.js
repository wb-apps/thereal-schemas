// @link https://schemas.thereal.com/json-schema/thereal/curator/command/delete-timeline/1-0-0.json#
...
export default class DeleteTimelineV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = DeleteTimelineV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:command:delete-timeline:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:command:delete-timeline';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-timeline:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:delete-node:v1',
