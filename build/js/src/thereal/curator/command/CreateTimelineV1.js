...
export default class CreateTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:curator:command:create-timeline:1-0-0', CreateTimelineV1,
      [],
      [
...
MessageResolver.register('thereal:curator:command:create-timeline', CreateTimelineV1);
