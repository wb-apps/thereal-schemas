// @link https://schemas.thereal.com/json-schema/thereal/curator/command/mark-timeline-as-pending/1-0-0.json#
...
export default class MarkTimelineAsPendingV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = MarkTimelineAsPendingV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:command:mark-timeline-as-pending:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:command:mark-timeline-as-pending';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:command:mark-timeline-as-pending:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:mark-node-as-pending:v1',
