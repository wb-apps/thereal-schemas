// @link https://schemas.thereal.com/json-schema/thereal/curator/command/rename-gallery/1-0-0.json#
...
export default class RenameGalleryV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = RenameGalleryV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:command:rename-gallery:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:command:rename-gallery';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:command:rename-gallery:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:rename-node:v1',
