// @link https://schemas.thereal.com/json-schema/thereal/curator/request/get-promotion-history-response/1-0-0.json#
...
export default class GetPromotionHistoryResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetPromotionHistoryResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:request:get-promotion-history-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:request:get-promotion-history-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-promotion-history-response:v1';
