...
export default class GetGalleryResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetGalleryResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:curator:request:get-gallery-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:curator:request:get-gallery-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-gallery-response:v1';
