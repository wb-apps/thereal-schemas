// @link https://schemas.thereal.com/json-schema/thereal/sys/request/get-picklist-request/1-0-0.json#
...
export default class GetPicklistRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetPicklistRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:sys:request:get-picklist-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:sys:request:get-picklist-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-picklist-request:v1';
