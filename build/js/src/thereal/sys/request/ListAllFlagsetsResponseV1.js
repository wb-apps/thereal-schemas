...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:sys:request:list-all-flagsets-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:sys:request:list-all-flagsets-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:sys:request:list-all-flagsets-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:response:v1',
  'gdbots:pbjx:mixin:response',
  'triniti:sys:mixin:list-all-flagsets-response:v1',
