...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:sys:request:list-all-picklists-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:sys:request:list-all-picklists-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:sys:request:list-all-picklists-request:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:request:v1',
  'gdbots:pbjx:mixin:request',
  'triniti:sys:mixin:list-all-picklists-request:v1',
