// @link https://schemas.thereal.com/json-schema/thereal/sys/request/get-flagset-request/1-0-0.json#
...
export default class GetFlagsetRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetFlagsetRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:sys:request:get-flagset-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:sys:request:get-flagset-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-flagset-request:v1';
