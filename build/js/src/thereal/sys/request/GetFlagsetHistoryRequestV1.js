// @link https://schemas.thereal.com/json-schema/thereal/sys/request/get-flagset-history-request/1-0-0.json#
...
export default class GetFlagsetHistoryRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetFlagsetHistoryRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:sys:request:get-flagset-history-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:sys:request:get-flagset-history-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-flagset-history-request:v1';
