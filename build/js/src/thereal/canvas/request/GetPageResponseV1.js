...
export default class GetPageResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:canvas:request:get-page-response:1-0-0', GetPageResponseV1,
      [],
      [
...
MessageResolver.register('thereal:canvas:request:get-page-response', GetPageResponseV1);
