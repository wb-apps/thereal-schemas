    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create('person_refs', T.NodeRefType.create())
          .asASet()
          .build(),
        Fb.create('redirect_ref', T.NodeRefType.create())
          .build(),
...
const M = PageV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:canvas:node:page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:canvas:node:page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:canvas:node:page:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:ncr:mixin:node:v1',
  'gdbots:ncr:mixin:node',
  'triniti:canvas:mixin:page:v1',
  ...
  'triniti:sys:mixin:vanity-urlable:v1',
