...
export default class PageUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:canvas:event:page-unpublished:1-0-0', PageUnpublishedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(PageUnpublishedV1);
MessageResolver.register('thereal:canvas:event:page-unpublished', PageUnpublishedV1);
Object.freeze(PageUnpublishedV1);
Object.freeze(PageUnpublishedV1.prototype);
