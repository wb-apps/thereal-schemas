// @link https://schemas.thereal.com/json-schema/thereal/canvas/event/page-unpublished/1-0-0.json#
...
export default class PageUnpublishedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = PageUnpublishedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:canvas:event:page-unpublished:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:canvas:event:page-unpublished';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-unpublished:v1';
