...
export default class PagePublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:canvas:event:page-published:1-0-0', PagePublishedV1,
      [],
      [
...
MessageResolver.register('thereal:canvas:event:page-published', PagePublishedV1);
