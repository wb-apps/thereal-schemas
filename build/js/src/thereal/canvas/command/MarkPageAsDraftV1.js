...
const M = MarkPageAsDraftV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:canvas:command:mark-page-as-draft:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:canvas:command:mark-page-as-draft';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:mark-page-as-draft:v1';
