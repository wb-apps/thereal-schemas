// @link https://schemas.thereal.com/json-schema/thereal/canvas/command/update-page/1-0-0.json#
...
const M = UpdatePageV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:canvas:command:update-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:canvas:command:update-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:update-page:v1';
