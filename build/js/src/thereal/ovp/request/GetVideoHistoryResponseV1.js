// @link https://schemas.thereal.com/json-schema/thereal/ovp/request/get-video-history-response/1-0-0.json#
...
export default class GetVideoHistoryResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetVideoHistoryResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:ovp:request:get-video-history-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:ovp:request:get-video-history-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:get-video-history-response:v1';
