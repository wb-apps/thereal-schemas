...
export default class VideoUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:ovp:event:video-unpublished:1-0-0', VideoUnpublishedV1,
      [],
      [
...
MessageResolver.register('thereal:ovp:event:video-unpublished', VideoUnpublishedV1);
