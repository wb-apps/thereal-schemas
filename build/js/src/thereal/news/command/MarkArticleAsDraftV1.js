...
const M = MarkArticleAsDraftV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:command:mark-article-as-draft:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:command:mark-article-as-draft';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:command:mark-article-as-draft:v1';
