// @link https://schemas.thereal.com/json-schema/thereal/news/command/publish-article/1-0-0.json#
...
const M = PublishArticleV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:command:publish-article:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:command:publish-article';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:command:publish-article:v1';
