...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:command:remove-article-slotting:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:command:remove-article-slotting';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:command:remove-article-slotting:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'triniti:news:mixin:remove-article-slotting:v1',
