...
const M = UnlockArticleV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:command:unlock-article:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:command:unlock-article';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:command:unlock-article:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:unlock-node:v1',
