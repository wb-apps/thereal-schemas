...
const M = LockArticleV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:command:lock-article:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:command:lock-article';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:command:lock-article:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:ncr:mixin:lock-node:v1',
