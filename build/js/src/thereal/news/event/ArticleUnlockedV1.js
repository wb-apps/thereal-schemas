...
const M = ArticleUnlockedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:event:article-unlocked:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:event:article-unlocked';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-unlocked:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:event:v1',
  'gdbots:pbjx:mixin:event',
  'gdbots:ncr:mixin:node-unlocked:v1',
