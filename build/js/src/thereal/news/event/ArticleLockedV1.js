...
export default class ArticleLockedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ArticleLockedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:event:article-locked:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:event:article-locked';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-locked:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:event:v1',
  'gdbots:pbjx:mixin:event',
  'gdbots:ncr:mixin:node-locked:v1',
