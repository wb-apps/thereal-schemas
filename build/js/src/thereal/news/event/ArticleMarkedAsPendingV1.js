// @link https://schemas.thereal.com/json-schema/thereal/news/event/article-marked-as-pending/1-0-0.json#
...
const M = ArticleMarkedAsPendingV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:news:event:article-marked-as-pending:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:news:event:article-marked-as-pending';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-marked-as-pending:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:event:v1',
  'gdbots:pbjx:mixin:event',
  'gdbots:ncr:mixin:node-marked-as-pending:v1',
