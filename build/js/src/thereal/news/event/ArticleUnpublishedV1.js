...
export default class ArticleUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:news:event:article-unpublished:1-0-0', ArticleUnpublishedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(ArticleUnpublishedV1);
MessageResolver.register('thereal:news:event:article-unpublished', ArticleUnpublishedV1);
Object.freeze(ArticleUnpublishedV1);
Object.freeze(ArticleUnpublishedV1.prototype);
