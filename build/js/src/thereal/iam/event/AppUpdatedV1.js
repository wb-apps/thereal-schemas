// @link https://schemas.thereal.com/json-schema/thereal/iam/event/app-updated/1-0-0.json#
...
export default class AppUpdatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = AppUpdatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:event:app-updated:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:event:app-updated';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:event:app-updated:v1';
