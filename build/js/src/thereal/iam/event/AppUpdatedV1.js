...
export default class AppUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:iam:event:app-updated:1-0-0', AppUpdatedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(AppUpdatedV1);
MessageResolver.register('thereal:iam:event:app-updated', AppUpdatedV1);
Object.freeze(AppUpdatedV1);
Object.freeze(AppUpdatedV1.prototype);
