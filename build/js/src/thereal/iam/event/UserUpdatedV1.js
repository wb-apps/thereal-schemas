// @link https://schemas.thereal.com/json-schema/thereal/iam/event/user-updated/1-0-0.json#
...
const M = UserUpdatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:event:user-updated:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:event:user-updated';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-updated:v1';
