...
export default class AppDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:thereal:iam:event:app-deleted:1-0-0', AppDeletedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(AppDeletedV1);
MessageResolver.register('thereal:iam:event:app-deleted', AppDeletedV1);
Object.freeze(AppDeletedV1);
Object.freeze(AppDeletedV1.prototype);
