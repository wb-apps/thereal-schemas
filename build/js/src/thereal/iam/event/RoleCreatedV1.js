// @link https://schemas.thereal.com/json-schema/thereal/iam/event/role-created/1-0-0.json#
...
const M = RoleCreatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:event:role-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:event:role-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:event:role-created:v1';
