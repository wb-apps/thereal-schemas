// @link https://schemas.thereal.com/json-schema/thereal/iam/event/user-deleted/1-0-0.json#
...
const M = UserDeletedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:event:user-deleted:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:event:user-deleted';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-deleted:v1';
