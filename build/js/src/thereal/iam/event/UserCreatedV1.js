// @link https://schemas.thereal.com/json-schema/thereal/iam/event/user-created/1-0-0.json#
...
const M = UserCreatedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:event:user-created:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:event:user-created';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-created:v1';
