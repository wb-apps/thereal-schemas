// @link https://schemas.thereal.com/json-schema/thereal/iam/request/get-app-response/1-0-0.json#
...
export default class GetAppResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = GetAppResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:request:get-app-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:request:get-app-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-app-response:v1';
