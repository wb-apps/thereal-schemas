// @link https://schemas.thereal.com/json-schema/thereal/iam/request/get-user-history-response/1-0-0.json#
...
const M = GetUserHistoryResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:request:get-user-history-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:request:get-user-history-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-user-history-response:v1';
