...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:request:get-user-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:request:get-user-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-user-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  ...
  'gdbots:iam:mixin:get-user-response:v1',
