// @link https://schemas.thereal.com/json-schema/thereal/iam/command/delete-app/1-0-0.json#
...
export default class DeleteAppV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = DeleteAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:command:delete-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:command:delete-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:command:delete-app:v1';
