// @link https://schemas.thereal.com/json-schema/thereal/iam/command/update-app/1-0-0.json#
...
export default class UpdateAppV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = UpdateAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:command:update-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:command:update-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:command:update-app:v1';
