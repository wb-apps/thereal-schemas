...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:command:grant-roles-to-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:command:grant-roles-to-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:command:grant-roles-to-user:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:command:v1',
  'gdbots:pbjx:mixin:command',
  'gdbots:iam:mixin:grant-roles-to-user:v1',
