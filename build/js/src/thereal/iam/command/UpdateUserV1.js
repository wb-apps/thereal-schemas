// @link https://schemas.thereal.com/json-schema/thereal/iam/command/update-user/1-0-0.json#
...
const M = UpdateUserV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:iam:command:update-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:iam:command:update-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:iam:command:update-user:v1';
