...
const M = BrowserNotificationV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:notify:node:browser-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:notify:node:browser-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:notify:node:browser-notification:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:ncr:mixin:node:v1',
  'gdbots:ncr:mixin:node',
  'triniti:notify:mixin:notification:v1',
  'triniti:notify:mixin:notification',
  'triniti:notify:mixin:browser-notification:v1',
  'triniti:notify:mixin:browser-notification',
];

GdbotsNcrNodeV1Mixin(M);

TrinitiNotifyBrowserNotificationV1Mixin(M);
