...
const M = SlackNotificationV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:notify:node:slack-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:notify:node:slack-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:notify:node:slack-notification:v1';
...
TrinitiNotifySlackNotificationV1Mixin(M);
