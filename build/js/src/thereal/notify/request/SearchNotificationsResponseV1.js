...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:notify:request:search-notifications-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:notify:request:search-notifications-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:notify:request:search-notifications-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  ...
  'triniti:notify:mixin:search-notifications-response:v1',
