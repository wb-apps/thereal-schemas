...
const M = CreateNotificationV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:notify:command:create-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:notify:command:create-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:notify:command:create-notification:v1';
