...
const M = DeleteNotificationV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:notify:command:delete-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:notify:command:delete-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:notify:command:delete-notification:v1';
