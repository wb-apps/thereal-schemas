...
const M = DeleteChannelV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:taxonomy:command:delete-channel:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:taxonomy:command:delete-channel';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:delete-channel:v1';
