...
const M = ChannelV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:taxonomy:node:channel:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:taxonomy:node:channel';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:node:channel:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:ncr:mixin:node:v1',
  'gdbots:ncr:mixin:node',
  'triniti:taxonomy:mixin:channel:v1',
...
TrinitiTaxonomyChannelV1Mixin(M);
