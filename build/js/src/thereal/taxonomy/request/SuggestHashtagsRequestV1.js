...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:taxonomy:request:suggest-hashtags-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:taxonomy:request:suggest-hashtags-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:suggest-hashtags-request:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:request:v1',
  'gdbots:pbjx:mixin:request',
  'triniti:taxonomy:mixin:suggest-hashtags-request:v1',
