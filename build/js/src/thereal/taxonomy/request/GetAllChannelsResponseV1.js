...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:thereal:taxonomy:request:get-all-channels-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'thereal:taxonomy:request:get-all-channels-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:get-all-channels-response:v1';
M.prototype.MIXINS = M.MIXINS = [
  'gdbots:pbjx:mixin:response:v1',
  'gdbots:pbjx:mixin:response',
  'triniti:taxonomy:mixin:get-all-channels-response:v1',
