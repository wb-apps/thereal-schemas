...
final class FlagsetDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:flagset-deleted:v1';
    const MIXINS = [
