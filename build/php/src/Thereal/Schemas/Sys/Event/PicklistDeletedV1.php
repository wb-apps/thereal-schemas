...
final class PicklistDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:picklist-deleted:v1';
    const MIXINS = [
