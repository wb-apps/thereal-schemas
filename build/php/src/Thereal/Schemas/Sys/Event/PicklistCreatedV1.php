...
final class PicklistCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:picklist-created:v1';
    const MIXINS = [
