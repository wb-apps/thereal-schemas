...
final class FlagsetUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:flagset-updated:v1';
    const MIXINS = [
