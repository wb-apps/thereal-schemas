...
final class PicklistUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:picklist-updated:v1';
    const MIXINS = [
