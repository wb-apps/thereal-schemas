...
final class FlagsetCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:flagset-created:v1';
    const MIXINS = [
