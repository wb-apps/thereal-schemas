...
final class RedirectUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:redirect-updated:v1';
    const MIXINS = [
