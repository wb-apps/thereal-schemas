...
final class RedirectCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:event:redirect-created:v1';
    const MIXINS = [
