...
{
    const SCHEMA_ID = 'pbj:thereal:sys:node:picklist:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:node:picklist';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:node:picklist:v1';
    const MIXINS = [
