...
final class DeleteRedirectV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:delete-redirect:v1';
    const MIXINS = [
