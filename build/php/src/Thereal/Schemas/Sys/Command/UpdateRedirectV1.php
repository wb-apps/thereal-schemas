...
final class UpdateRedirectV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:update-redirect:v1';
    const MIXINS = [
