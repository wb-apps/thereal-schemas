...
final class CreateFlagsetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:create-flagset:v1';
    const MIXINS = [
