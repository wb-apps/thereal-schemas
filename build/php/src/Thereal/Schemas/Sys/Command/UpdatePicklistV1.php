...
final class UpdatePicklistV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:update-picklist:v1';
    const MIXINS = [
