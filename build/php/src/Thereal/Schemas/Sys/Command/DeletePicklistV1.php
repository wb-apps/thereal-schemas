...
final class DeletePicklistV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:delete-picklist:v1';
    const MIXINS = [
