...
final class CreatePicklistV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:create-picklist:v1';
    const MIXINS = [
