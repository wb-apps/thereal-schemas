...
final class DeleteFlagsetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:delete-flagset:v1';
    const MIXINS = [
