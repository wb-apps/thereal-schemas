...
final class CreateRedirectV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:create-redirect:v1';
    const MIXINS = [
