...
final class UpdateFlagsetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:command:update-flagset:v1';
    const MIXINS = [
