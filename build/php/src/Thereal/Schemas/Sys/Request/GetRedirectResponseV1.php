...
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-redirect-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-redirect-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-redirect-response:v1';
    const MIXINS = [
