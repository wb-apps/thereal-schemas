...
final class GetRedirectHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-redirect-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-redirect-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-redirect-history-request:v1';
    const MIXINS = [
