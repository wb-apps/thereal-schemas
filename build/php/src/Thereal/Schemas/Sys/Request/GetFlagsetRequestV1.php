...
final class GetFlagsetRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-flagset-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-flagset-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-flagset-request:v1';
    const MIXINS = [
