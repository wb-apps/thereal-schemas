...
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-redirect-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-redirect-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-redirect-request:v1';
    const MIXINS = [
