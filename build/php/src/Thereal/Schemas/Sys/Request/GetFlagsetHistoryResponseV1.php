...
final class GetFlagsetHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-flagset-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-flagset-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-flagset-history-response:v1';
    const MIXINS = [
