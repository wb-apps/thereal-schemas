...
final class GetPicklistRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-picklist-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-picklist-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-picklist-request:v1';
    const MIXINS = [
