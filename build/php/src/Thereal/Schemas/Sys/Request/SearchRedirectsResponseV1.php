...
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:search-redirects-response:v1';
    const MIXINS = [
