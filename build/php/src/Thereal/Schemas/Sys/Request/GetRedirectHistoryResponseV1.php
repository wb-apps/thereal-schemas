...
final class GetRedirectHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:get-redirect-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:get-redirect-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:get-redirect-history-response:v1';
    const MIXINS = [
