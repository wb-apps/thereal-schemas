...
{
    const SCHEMA_ID = 'pbj:thereal:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:sys:request:search-redirects-request:v1';
    const MIXINS = [
