...
final class GetPicklistHistoryRequestV1 extends AbstractMessage implements
    GetPicklistHistoryRequest,
    GdbotsPbjxRequestV1,
    GdbotsPbjxGetEventsRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:sys:request:get-picklist-history-request:1-0-0', __CLASS__,
            [],
            [
