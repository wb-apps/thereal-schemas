...
final class PageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:node:page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:node:page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:node:page:v1';
    const MIXINS = [
