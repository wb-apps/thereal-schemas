...
final class UpdatePageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:update-page:v1';
    const MIXINS = [
