...
final class CreatePageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:create-page:v1';
    const MIXINS = [
