...
final class RenamePageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:rename-page:v1';
    const MIXINS = [
