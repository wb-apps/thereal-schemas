...
final class UnpublishPageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:unpublish-page:v1';
    const MIXINS = [
