...
final class DeletePageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:delete-page:v1';
    const MIXINS = [
