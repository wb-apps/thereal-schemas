...
final class PublishPageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:publish-page:v1';
    const MIXINS = [
