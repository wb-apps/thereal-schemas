...
final class ExpirePageV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:command:expire-page:v1';
    const MIXINS = [
