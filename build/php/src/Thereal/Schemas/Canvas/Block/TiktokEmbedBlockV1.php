...
final class TiktokEmbedBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:tiktok-embed-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:tiktok-embed-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:tiktok-embed-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasTiktokEmbedBlockV1Mixin;
