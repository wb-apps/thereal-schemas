...
final class ArticleBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:article-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasArticleBlockV1Mixin;
