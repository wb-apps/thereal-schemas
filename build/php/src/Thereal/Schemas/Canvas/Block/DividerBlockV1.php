...
final class DividerBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:divider-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasDividerBlockV1Mixin;
