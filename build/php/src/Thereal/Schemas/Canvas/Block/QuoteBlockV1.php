...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:quote-block:v1';
    const MIXINS = [
