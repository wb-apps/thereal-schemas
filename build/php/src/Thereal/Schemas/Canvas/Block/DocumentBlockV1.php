...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:document-block:v1';
    const MIXINS = [
