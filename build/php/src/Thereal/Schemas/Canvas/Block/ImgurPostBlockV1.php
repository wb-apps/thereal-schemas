...
final class ImgurPostBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:imgur-post-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasImgurPostBlockV1Mixin;
