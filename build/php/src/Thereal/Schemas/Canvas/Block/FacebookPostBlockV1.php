...
final class FacebookPostBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:facebook-post-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:facebook-post-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:facebook-post-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasFacebookPostBlockV1Mixin;
