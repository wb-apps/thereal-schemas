...
final class PinterestPinBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:pinterest-pin-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:pinterest-pin-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:pinterest-pin-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasPinterestPinBlockV1Mixin;
