...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:poll-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:poll-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:poll-block:v1';
    const MIXINS = [
