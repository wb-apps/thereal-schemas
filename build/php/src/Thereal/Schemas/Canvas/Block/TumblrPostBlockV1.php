...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:tumblr-post-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:tumblr-post-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:tumblr-post-block:v1';
    const MIXINS = [
