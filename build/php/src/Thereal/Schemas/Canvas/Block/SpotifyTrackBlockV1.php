...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:spotify-track-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:spotify-track-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:spotify-track-block:v1';
    const MIXINS = [
