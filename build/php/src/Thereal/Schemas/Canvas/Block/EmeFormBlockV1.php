...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:eme-form-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:eme-form-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:eme-form-block:v1';
    const MIXINS = [
