...
final class PageBreakBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:page-break-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:page-break-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:page-break-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasPageBreakBlockV1Mixin;
