...
final class FacebookVideoBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:facebook-video-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:facebook-video-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:facebook-video-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasFacebookVideoBlockV1Mixin;
