...
final class TextBlockV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:block:text-block:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:block:text-block';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:block:text-block:v1';
    const MIXINS = [
    ...
    use TrinitiCanvasTextBlockV1Mixin;
