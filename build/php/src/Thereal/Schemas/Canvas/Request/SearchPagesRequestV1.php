...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:request:search-pages-request:v1';
    const MIXINS = [
