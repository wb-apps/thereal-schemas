...
{
    const SCHEMA_ID = 'pbj:thereal:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:request:search-pages-response:v1';
    const MIXINS = [
