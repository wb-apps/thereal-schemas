...
final class GetPageResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:request:get-page-response:v1';
    const MIXINS = [
