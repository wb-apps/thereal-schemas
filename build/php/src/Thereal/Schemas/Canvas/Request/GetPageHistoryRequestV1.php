...
final class GetPageHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:request:get-page-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:request:get-page-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:request:get-page-history-request:v1';
    const MIXINS = [
