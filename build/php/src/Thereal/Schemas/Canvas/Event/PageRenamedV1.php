...
final class PageRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-renamed:v1';
    const MIXINS = [
