...
final class PageUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-updated:v1';
    const MIXINS = [
