...
final class PageScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-scheduled:v1';
    const MIXINS = [
