...
final class PageDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-deleted:v1';
    const MIXINS = [
