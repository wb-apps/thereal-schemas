...
final class PageUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-unpublished:v1';
    const MIXINS = [
