...
final class PageCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-created:v1';
    const MIXINS = [
