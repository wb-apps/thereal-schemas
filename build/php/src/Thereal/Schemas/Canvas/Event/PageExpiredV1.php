...
final class PageExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-expired:v1';
    const MIXINS = [
