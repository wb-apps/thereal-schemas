...
final class PagePublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:canvas:event:page-published:v1';
    const MIXINS = [
