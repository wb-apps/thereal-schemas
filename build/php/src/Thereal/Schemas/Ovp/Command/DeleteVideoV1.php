...
final class DeleteVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:delete-video:v1';
    const MIXINS = [
