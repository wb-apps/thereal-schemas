...
final class RenameVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:rename-video:v1';
    const MIXINS = [
