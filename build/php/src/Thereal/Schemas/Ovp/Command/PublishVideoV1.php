...
final class PublishVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:publish-video:v1';
    const MIXINS = [
