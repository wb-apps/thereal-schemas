...
final class ExpireVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:expire-video:v1';
    const MIXINS = [
