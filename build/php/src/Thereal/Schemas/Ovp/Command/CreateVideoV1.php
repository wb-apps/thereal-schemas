...
final class CreateVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:create-video:v1';
    const MIXINS = [
