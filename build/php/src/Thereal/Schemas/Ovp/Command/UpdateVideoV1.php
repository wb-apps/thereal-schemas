...
final class UpdateVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:update-video:v1';
    const MIXINS = [
