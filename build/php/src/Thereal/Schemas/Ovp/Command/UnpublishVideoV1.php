...
final class UnpublishVideoV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:command:unpublish-video:v1';
    const MIXINS = [
