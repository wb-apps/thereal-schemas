...
final class GetVideoHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:get-video-history-request:v1';
    const MIXINS = [
