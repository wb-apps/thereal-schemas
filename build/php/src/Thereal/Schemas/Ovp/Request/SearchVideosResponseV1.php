...
{
    const SCHEMA_ID = 'pbj:thereal:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:search-videos-response:v1';
    const MIXINS = [
