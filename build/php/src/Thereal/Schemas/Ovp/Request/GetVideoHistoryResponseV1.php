...
final class GetVideoHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:get-video-history-response:v1';
    const MIXINS = [
