...
{
    const SCHEMA_ID = 'pbj:thereal:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:search-videos-request:v1';
    const MIXINS = [
