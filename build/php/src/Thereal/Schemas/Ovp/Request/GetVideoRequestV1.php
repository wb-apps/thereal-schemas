...
final class GetVideoRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:get-video-request:v1';
    const MIXINS = [
