...
final class GetVideoResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:request:get-video-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:request:get-video-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:request:get-video-response:v1';
    const MIXINS = [
