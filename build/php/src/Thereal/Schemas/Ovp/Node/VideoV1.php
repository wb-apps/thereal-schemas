...
{
    const SCHEMA_ID = 'pbj:thereal:ovp:node:video:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:node:video';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:node:video:v1';
    const MIXINS = [
