...
final class VideoCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-created:v1';
    const MIXINS = [
