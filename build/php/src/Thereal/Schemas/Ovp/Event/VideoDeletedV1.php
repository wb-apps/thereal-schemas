...
final class VideoDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-deleted:v1';
    const MIXINS = [
