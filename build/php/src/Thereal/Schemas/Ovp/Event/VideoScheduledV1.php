...
final class VideoScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-scheduled:v1';
    const MIXINS = [
