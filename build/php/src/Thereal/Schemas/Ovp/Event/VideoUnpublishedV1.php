...
final class VideoUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-unpublished:v1';
    const MIXINS = [
