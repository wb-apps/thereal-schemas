...
final class VideoRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-renamed:v1';
    const MIXINS = [
