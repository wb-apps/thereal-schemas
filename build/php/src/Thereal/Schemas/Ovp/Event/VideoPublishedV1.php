...
final class VideoPublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-published:v1';
    const MIXINS = [
