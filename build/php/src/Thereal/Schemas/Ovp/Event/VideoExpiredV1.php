...
final class VideoExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-expired:v1';
    const MIXINS = [
