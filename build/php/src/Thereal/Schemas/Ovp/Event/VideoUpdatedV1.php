...
final class VideoUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:ovp:event:video-updated:v1';
    const MIXINS = [
