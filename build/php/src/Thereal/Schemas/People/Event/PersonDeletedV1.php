...
final class PersonDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:event:person-deleted:v1';
    const MIXINS = [
