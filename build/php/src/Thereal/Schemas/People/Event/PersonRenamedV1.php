...
final class PersonRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:event:person-renamed:v1';
    const MIXINS = [
