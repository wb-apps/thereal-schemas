...
final class PersonCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:event:person-created:v1';
    const MIXINS = [
