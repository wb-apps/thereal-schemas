...
namespace Thereal\Schemas\People\Event;
...
final class PersonUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:event:person-updated:v1';
    const MIXINS = [
