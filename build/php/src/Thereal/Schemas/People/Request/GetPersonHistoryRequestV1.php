...
{
    const SCHEMA_ID = 'pbj:thereal:people:request:get-person-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:request:get-person-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:request:get-person-history-request:v1';
    const MIXINS = [
