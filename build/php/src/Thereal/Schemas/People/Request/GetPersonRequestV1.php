...
final class GetPersonRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:request:get-person-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:request:get-person-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:request:get-person-request:v1';
    const MIXINS = [
