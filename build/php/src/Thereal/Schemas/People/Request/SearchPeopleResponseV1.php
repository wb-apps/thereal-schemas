...
{
    const SCHEMA_ID = 'pbj:thereal:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:request:search-people-response:v1';
    const MIXINS = [
