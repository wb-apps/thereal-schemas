...
final class GetPersonHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:request:get-person-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:request:get-person-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:request:get-person-history-response:v1';
    const MIXINS = [
