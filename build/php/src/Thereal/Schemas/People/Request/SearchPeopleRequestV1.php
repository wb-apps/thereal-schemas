...
{
    const SCHEMA_ID = 'pbj:thereal:people:request:search-people-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:request:search-people-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:request:search-people-request:v1';
    const MIXINS = [
