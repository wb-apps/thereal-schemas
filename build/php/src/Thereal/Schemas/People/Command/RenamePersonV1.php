...
final class RenamePersonV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:command:rename-person:v1';
    const MIXINS = [
