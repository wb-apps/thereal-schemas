...
final class DeletePersonV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:command:delete-person:v1';
    const MIXINS = [
