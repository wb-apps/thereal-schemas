...
final class CreatePersonV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:command:create-person:v1';
    const MIXINS = [
