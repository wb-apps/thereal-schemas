...
namespace Thereal\Schemas\People\Command;
...
final class UpdatePersonV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'thereal:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'thereal:people:command:update-person:v1';
    const MIXINS = [
