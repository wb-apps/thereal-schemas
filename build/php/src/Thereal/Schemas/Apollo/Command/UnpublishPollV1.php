...
final class UnpublishPollV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:unpublish-poll:v1';
    const MIXINS = [
