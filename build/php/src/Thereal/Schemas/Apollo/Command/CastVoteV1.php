...
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:cast-vote:v1';
    const MIXINS = [
