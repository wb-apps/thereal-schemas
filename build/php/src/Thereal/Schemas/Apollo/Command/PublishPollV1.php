...
final class PublishPollV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:publish-poll:v1';
    const MIXINS = [
