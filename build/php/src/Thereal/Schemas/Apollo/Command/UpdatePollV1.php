...
final class UpdatePollV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:update-poll:v1';
    const MIXINS = [
