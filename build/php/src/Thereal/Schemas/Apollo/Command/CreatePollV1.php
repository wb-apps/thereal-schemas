...
final class CreatePollV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:create-poll:v1';
    const MIXINS = [
