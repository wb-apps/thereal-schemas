...
final class ExpirePollV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:expire-poll:v1';
    const MIXINS = [
