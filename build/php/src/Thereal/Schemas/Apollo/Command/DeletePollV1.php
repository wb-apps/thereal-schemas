...
final class DeletePollV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:command:delete-poll:v1';
    const MIXINS = [
