...
final class PollStatsV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:node:poll-stats:v1';
    const MIXINS = [
    ...
    use TrinitiApolloPollStatsV1Mixin;
