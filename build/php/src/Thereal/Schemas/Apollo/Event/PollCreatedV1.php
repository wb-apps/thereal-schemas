...
final class PollCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-created:v1';
    const MIXINS = [
