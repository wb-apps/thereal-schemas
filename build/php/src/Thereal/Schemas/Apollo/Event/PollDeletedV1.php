...
final class PollDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-deleted:v1';
    const MIXINS = [
