...
final class PollUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-updated:v1';
    const MIXINS = [
