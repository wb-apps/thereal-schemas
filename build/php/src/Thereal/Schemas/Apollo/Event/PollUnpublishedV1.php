...
final class PollUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-unpublished:v1';
    const MIXINS = [
