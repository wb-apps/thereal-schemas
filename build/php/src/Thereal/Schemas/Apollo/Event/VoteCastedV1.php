...
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:vote-casted:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:vote-casted';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:vote-casted:v1';
    const MIXINS = [
