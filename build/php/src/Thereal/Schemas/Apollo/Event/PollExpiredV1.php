...
final class PollExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-expired:v1';
    const MIXINS = [
