...
final class PollScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-scheduled:v1';
    const MIXINS = [
