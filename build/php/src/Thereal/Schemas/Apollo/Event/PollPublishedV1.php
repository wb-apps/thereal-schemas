...
final class PollPublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:event:poll-published:v1';
    const MIXINS = [
