...
final class GetPollHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:request:get-poll-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:request:get-poll-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:request:get-poll-history-request:v1';
    const MIXINS = [
