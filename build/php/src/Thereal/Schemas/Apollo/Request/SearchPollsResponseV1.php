...
{
    const SCHEMA_ID = 'pbj:thereal:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:request:search-polls-response:v1';
    const MIXINS = [
