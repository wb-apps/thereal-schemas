...
{
    const SCHEMA_ID = 'pbj:thereal:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:request:search-polls-request:v1';
    const MIXINS = [
