...
final class GetPollRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:request:get-poll-request:v1';
    const MIXINS = [
