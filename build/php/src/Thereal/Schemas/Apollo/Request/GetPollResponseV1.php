...
final class GetPollResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:apollo:request:get-poll-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:apollo:request:get-poll-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:apollo:request:get-poll-response:v1';
    const MIXINS = [
