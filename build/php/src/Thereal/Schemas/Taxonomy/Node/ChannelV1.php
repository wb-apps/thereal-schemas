...
final class ChannelV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:node:channel:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:node:channel';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:node:channel:v1';
    const MIXINS = [
    ...
    use TrinitiTaxonomyChannelV1Mixin;
