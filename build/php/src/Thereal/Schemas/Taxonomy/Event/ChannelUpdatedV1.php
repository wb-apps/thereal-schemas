...
final class ChannelUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:channel-updated:v1';
    const MIXINS = [
