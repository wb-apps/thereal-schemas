...
final class ChannelRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:channel-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:channel-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:channel-renamed:v1';
    const MIXINS = [
