...
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:channel-created:v1';
    const MIXINS = [
