...
final class CategoryCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:category-created:v1';
    const MIXINS = [
