...
final class CategoryDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:category-deleted:v1';
    const MIXINS = [
