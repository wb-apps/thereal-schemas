...
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:category-updated:v1';
    const MIXINS = [
