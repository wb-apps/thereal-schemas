...
final class CategoryRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:event:category-renamed:v1';
    const MIXINS = [
