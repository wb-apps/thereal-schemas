...
final class CreateChannelV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:create-channel:v1';
    const MIXINS = [
