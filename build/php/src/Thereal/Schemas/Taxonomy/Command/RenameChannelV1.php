...
final class RenameChannelV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:rename-channel:v1';
    const MIXINS = [
