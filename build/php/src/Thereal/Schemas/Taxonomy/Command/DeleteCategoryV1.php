...
final class DeleteCategoryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:delete-category:v1';
    const MIXINS = [
