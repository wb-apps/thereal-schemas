...
final class CreateCategoryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:create-category:v1';
    const MIXINS = [
