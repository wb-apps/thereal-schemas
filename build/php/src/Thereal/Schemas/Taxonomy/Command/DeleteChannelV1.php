...
final class DeleteChannelV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:delete-channel:v1';
    const MIXINS = [
