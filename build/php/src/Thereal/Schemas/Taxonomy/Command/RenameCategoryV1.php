...
final class RenameCategoryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:rename-category:v1';
    const MIXINS = [
