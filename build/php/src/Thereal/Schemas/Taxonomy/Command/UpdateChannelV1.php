...
final class UpdateChannelV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:update-channel:v1';
    const MIXINS = [
