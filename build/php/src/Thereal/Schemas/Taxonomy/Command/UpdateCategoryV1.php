...
final class UpdateCategoryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:command:update-category:v1';
    const MIXINS = [
