...
final class GetCategoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:request:get-category-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:request:get-category-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:get-category-response:v1';
    const MIXINS = [
