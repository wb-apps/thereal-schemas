...
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:request:get-all-channels-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:request:get-all-channels-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:get-all-channels-request:v1';
    const MIXINS = [
