...
final class GetChannelHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:request:get-channel-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:request:get-channel-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:get-channel-history-request:v1';
    const MIXINS = [
