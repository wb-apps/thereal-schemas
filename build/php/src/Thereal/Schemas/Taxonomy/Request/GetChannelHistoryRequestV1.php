...
final class GetChannelHistoryRequestV1 extends AbstractMessage implements
    ...
    GdbotsPbjxGetEventsRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:taxonomy:request:get-channel-history-request:1-0-0', __CLASS__,
            [],
            [
