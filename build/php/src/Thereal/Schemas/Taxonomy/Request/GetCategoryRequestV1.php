...
final class GetCategoryRequestV1 extends AbstractMessage implements
    GetCategoryRequest,
    GdbotsPbjxRequestV1,
    GdbotsNcrGetNodeRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:taxonomy:request:get-category-request:1-0-0', __CLASS__,
            [],
            [
