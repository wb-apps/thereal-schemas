...
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:request:get-all-channels-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:request:get-all-channels-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:get-all-channels-response:v1';
    const MIXINS = [
