...
{
    const SCHEMA_ID = 'pbj:thereal:taxonomy:request:search-categories-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:taxonomy:request:search-categories-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:taxonomy:request:search-categories-response:v1';
    const MIXINS = [
