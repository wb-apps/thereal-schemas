...
final class NotificationDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:event:notification-deleted:v1';
    const MIXINS = [
