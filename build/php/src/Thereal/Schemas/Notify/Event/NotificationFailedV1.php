...
{
    const SCHEMA_ID = 'pbj:thereal:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:event:notification-failed:v1';
    const MIXINS = [
