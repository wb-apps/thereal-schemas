...
final class NotificationCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:event:notification-created:v1';
    const MIXINS = [
