...
final class NotificationUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:event:notification-updated:v1';
    const MIXINS = [
