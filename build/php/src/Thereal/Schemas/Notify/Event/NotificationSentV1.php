...
{
    const SCHEMA_ID = 'pbj:thereal:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:event:notification-sent:v1';
    const MIXINS = [
