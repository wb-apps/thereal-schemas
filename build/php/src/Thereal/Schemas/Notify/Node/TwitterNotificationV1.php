...
final class TwitterNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:twitter-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifyTwitterNotificationV1Mixin;
