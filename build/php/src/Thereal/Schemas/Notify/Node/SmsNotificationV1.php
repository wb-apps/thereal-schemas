...
final class SmsNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:sms-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifySmsNotificationV1Mixin;
