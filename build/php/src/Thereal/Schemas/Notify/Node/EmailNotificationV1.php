...
final class EmailNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:email-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifyEmailNotificationV1Mixin;
