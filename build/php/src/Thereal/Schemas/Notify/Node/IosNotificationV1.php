...
final class IosNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:ios-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifyIosNotificationV1Mixin;
