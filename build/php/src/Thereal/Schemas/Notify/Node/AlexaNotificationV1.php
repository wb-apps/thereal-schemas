...
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:alexa-notification:v1';
    const MIXINS = [
