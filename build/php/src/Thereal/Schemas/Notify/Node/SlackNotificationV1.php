...
final class SlackNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:slack-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifySlackNotificationV1Mixin;
