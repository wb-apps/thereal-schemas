...
final class AndroidNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:android-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifyAndroidNotificationV1Mixin;
