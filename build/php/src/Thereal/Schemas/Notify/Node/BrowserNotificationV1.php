...
final class BrowserNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:node:browser-notification:v1';
    const MIXINS = [
    ...
    use TrinitiNotifyBrowserNotificationV1Mixin;
