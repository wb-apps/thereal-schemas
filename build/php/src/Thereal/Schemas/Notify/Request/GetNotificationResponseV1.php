...
final class GetNotificationResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:request:get-notification-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:request:get-notification-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:request:get-notification-response:v1';
    const MIXINS = [
