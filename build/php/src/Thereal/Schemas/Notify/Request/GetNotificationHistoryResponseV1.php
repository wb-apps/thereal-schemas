...
final class GetNotificationHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:request:get-notification-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:request:get-notification-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:request:get-notification-history-response:v1';
    const MIXINS = [
