...
{
    const SCHEMA_ID = 'pbj:thereal:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:request:search-notifications-response:v1';
    const MIXINS = [
