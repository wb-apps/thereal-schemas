...
final class GetNotificationHistoryRequestV1 extends AbstractMessage implements
    ...
    GdbotsPbjxGetEventsRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:notify:request:get-notification-history-request:1-0-0', __CLASS__,
            [],
            [
