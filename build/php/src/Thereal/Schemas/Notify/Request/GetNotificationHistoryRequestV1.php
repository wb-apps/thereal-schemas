...
// @link https://schemas.thereal.com/json-schema/thereal/notify/request/get-notification-history-request/1-0-0.json#
...
final class GetNotificationHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:request:get-notification-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:request:get-notification-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:request:get-notification-history-request:v1';
    const MIXINS = [
