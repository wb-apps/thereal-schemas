...
final class GetNotificationRequestV1 extends AbstractMessage implements
    ...
    GdbotsNcrGetNodeRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:notify:request:get-notification-request:1-0-0', __CLASS__,
            [],
            [
