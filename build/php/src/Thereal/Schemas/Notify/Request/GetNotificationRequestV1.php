...
final class GetNotificationRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:request:get-notification-request:v1';
    const MIXINS = [
