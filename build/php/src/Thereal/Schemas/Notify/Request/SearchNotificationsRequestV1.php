...
{
    const SCHEMA_ID = 'pbj:thereal:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:request:search-notifications-request:v1';
    const MIXINS = [
