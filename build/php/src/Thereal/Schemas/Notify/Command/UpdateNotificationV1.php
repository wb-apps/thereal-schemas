...
final class UpdateNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:command:update-notification:v1';
    const MIXINS = [
