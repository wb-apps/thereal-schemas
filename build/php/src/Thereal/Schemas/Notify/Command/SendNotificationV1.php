...
{
    const SCHEMA_ID = 'pbj:thereal:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:command:send-notification:v1';
    const MIXINS = [
