...
final class DeleteNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:command:delete-notification:v1';
    const MIXINS = [
