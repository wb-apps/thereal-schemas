...
final class CreateNotificationV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'thereal:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'thereal:notify:command:create-notification:v1';
    const MIXINS = [
