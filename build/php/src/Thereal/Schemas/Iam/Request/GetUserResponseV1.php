...
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-user-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-user-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-user-response:v1';
    const MIXINS = [
