...
final class GetUserHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-user-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-user-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-user-history-response:v1';
    const MIXINS = [
