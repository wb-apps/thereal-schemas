...
final class ListAllRolesResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:list-all-roles-response:v1';
    const MIXINS = [
