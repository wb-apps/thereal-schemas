...
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:search-users-response:v1';
    const MIXINS = [
