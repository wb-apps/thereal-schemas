...
final class GetAllAppsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-all-apps-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-all-apps-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-all-apps-request:v1';
    const MIXINS = [
