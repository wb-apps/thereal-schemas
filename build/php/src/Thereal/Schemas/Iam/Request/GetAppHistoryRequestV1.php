...
final class GetAppHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-app-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-app-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-app-history-request:v1';
    const MIXINS = [
