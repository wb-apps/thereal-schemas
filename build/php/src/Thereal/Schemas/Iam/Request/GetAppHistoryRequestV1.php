...
final class GetAppHistoryRequestV1 extends AbstractMessage implements
    ...
    GdbotsPbjxGetEventsRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:iam:request:get-app-history-request:1-0-0', __CLASS__,
            [],
            [
