...
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-user-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-user-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-user-request:v1';
    const MIXINS = [
