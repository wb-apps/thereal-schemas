...
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:search-users-request:v1';
    const MIXINS = [
