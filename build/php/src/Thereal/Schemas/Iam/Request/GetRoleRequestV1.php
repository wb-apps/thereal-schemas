...
final class GetRoleRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-role-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-role-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-role-request:v1';
    const MIXINS = [
