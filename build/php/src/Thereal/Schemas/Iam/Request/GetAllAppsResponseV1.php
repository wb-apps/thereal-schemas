...
final class GetAllAppsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-all-apps-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-all-apps-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-all-apps-response:v1';
    const MIXINS = [
