...
final class ListAllRolesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:list-all-roles-request:v1';
    const MIXINS = [
