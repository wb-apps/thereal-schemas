...
final class GetAppHistoryResponseV1 extends AbstractMessage implements
    ...
    GdbotsPbjxGetEventsResponseV1
{
    ...
    {
        return new Schema('pbj:thereal:iam:request:get-app-history-response:1-0-0', __CLASS__,
            [],
            [
