...
final class GetRoleHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:request:get-role-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:request:get-role-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:request:get-role-history-response:v1';
    const MIXINS = [
