...
final class RoleCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:role-created:v1';
    const MIXINS = [
