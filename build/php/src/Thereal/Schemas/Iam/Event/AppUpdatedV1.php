...
final class AppUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:app-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:app-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:app-updated:v1';
    const MIXINS = [
