...
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-roles-revoked:v1';
    const MIXINS = [
