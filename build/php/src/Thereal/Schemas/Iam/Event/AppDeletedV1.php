...
final class AppDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:app-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:app-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:app-deleted:v1';
    const MIXINS = [
