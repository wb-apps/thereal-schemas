...
final class UserCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-created:v1';
    const MIXINS = [
