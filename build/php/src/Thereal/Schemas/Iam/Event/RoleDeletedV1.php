...
final class RoleDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:role-deleted:v1';
    const MIXINS = [
