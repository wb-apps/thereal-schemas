...
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:user-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:user-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-updated:v1';
    const MIXINS = [
