...
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-roles-granted:v1';
    const MIXINS = [
