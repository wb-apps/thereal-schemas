...
final class UserDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:user-deleted:v1';
    const MIXINS = [
