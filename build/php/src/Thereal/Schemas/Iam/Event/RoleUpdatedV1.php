...
final class RoleUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:role-updated:v1';
    const MIXINS = [
