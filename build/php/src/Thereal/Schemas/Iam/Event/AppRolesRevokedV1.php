...
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:app-roles-revoked:v1';
    const MIXINS = [
