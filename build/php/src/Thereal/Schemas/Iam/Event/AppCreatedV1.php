...
final class AppCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:app-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:app-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:app-created:v1';
    const MIXINS = [
