...
{
    const SCHEMA_ID = 'pbj:thereal:iam:event:app-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:event:app-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:event:app-roles-granted:v1';
    const MIXINS = [
