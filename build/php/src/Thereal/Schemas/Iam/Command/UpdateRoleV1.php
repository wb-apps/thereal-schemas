...
final class UpdateRoleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:update-role:v1';
    const MIXINS = [
