...
final class CreateRoleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:create-role:v1';
    const MIXINS = [
