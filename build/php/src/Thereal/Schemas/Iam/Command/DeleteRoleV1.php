...
final class DeleteRoleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:delete-role:v1';
    const MIXINS = [
