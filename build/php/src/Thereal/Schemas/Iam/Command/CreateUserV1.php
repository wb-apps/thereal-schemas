...
final class CreateUserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:create-user:v1';
    const MIXINS = [
