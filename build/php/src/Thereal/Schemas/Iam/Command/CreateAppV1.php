...
final class CreateAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:create-app:v1';
    const MIXINS = [
