...
final class UpdateAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:update-app:v1';
    const MIXINS = [
