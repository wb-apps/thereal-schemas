...
final class UpdateUserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:update-user:v1';
    const MIXINS = [
