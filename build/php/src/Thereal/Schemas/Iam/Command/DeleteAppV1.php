...
final class DeleteAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:delete-app:v1';
    const MIXINS = [
