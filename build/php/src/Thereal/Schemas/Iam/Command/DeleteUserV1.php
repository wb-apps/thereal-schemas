...
final class DeleteUserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:command:delete-user:v1';
    const MIXINS = [
