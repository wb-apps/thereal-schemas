...
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:sms-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:sms-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:sms-app:v1';
    const MIXINS = [
