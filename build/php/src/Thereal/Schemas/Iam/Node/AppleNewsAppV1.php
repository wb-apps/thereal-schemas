...
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:apple-news-app:v1';
    const MIXINS = [
    ...
    use GdbotsIamAppleNewsAppV1Mixin;
