...
final class EmailAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:email-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:email-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:email-app:v1';
    const MIXINS = [
