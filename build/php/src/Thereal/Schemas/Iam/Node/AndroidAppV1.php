...
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:android-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:android-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:android-app:v1';
    const MIXINS = [
    ...
    use GdbotsIamAndroidAppV1Mixin;
