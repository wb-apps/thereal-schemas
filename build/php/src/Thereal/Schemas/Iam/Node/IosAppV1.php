...
final class IosAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:ios-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:ios-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:ios-app:v1';
    const MIXINS = [
