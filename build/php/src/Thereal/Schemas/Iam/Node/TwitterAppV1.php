...
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:twitter-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:twitter-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:twitter-app:v1';
    const MIXINS = [
