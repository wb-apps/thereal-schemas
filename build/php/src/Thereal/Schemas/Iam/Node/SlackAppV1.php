...
final class SlackAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:slack-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:slack-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:slack-app:v1';
    const MIXINS = [
