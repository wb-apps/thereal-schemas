...
final class BrowserAppV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:iam:node:browser-app:1-0-0';
    const SCHEMA_CURIE = 'thereal:iam:node:browser-app';
    const SCHEMA_CURIE_MAJOR = 'thereal:iam:node:browser-app:v1';
    const MIXINS = [
    ...
    use GdbotsIamBrowserAppV1Mixin;
