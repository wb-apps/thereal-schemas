...
final class HeroBarWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:hero-bar-widget:v1';
    const MIXINS = [
      'gdbots:ncr:mixin:node:v1',
      'gdbots:ncr:mixin:node',
      'triniti:curator:mixin:widget:v1',
      'triniti:curator:mixin:widget',
      'triniti:curator:mixin:hero-bar-widget:v1',
    ...
    use TrinitiCuratorHeroBarWidgetV1Mixin;
