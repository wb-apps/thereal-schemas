...
final class CategoryTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:category-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorCategoryTeaserV1Mixin;
