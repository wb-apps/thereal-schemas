...
final class ArticleTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:article-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorArticleTeaserV1Mixin;
