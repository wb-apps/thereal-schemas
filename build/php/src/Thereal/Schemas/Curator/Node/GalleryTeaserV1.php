...
final class GalleryTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:gallery-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorGalleryTeaserV1Mixin;
