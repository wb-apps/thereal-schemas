...
final class GridlerWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:gridler-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorGridlerWidgetV1Mixin;
