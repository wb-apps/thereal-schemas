...
final class MediaListWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:media-list-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorMediaListWidgetV1Mixin;
