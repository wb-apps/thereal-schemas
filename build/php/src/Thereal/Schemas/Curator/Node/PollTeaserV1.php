...
use Triniti\Schemas\Curator\Mixin\PollTeaser\PollTeaserV1 as TrinitiCuratorPollTeaserV1;
use Triniti\Schemas\Curator\Mixin\PollTeaser\PollTeaserV1Mixin as TrinitiCuratorPollTeaserV1Mixin;
use Triniti\Schemas\Curator\Mixin\PollTeaser\PollTeaserV1Trait as TrinitiCuratorPollTeaserV1Trait;
...
final class PollTeaserV1 extends AbstractMessage implements
    PollTeaser,
    GdbotsNcrNodeV1,
    TrinitiCuratorTeaserV1,
    TrinitiCuratorTeaserHasTargetV1,
    TrinitiCuratorPollTeaserV1,
    ...
    TrinitiTaxonomyHashtaggableV1
{
    ...
    use TrinitiCuratorPollTeaserV1Trait;
    ...
    {
        return new Schema('pbj:thereal:curator:node:poll-teaser:1-0-0', __CLASS__,
            [],
            [
