...
final class PollTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:poll-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorPollTeaserV1Mixin;
