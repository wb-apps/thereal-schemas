...
final class VideoTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:video-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorVideoTeaserV1Mixin;
