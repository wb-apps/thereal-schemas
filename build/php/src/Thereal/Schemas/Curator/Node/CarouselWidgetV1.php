...
final class CarouselWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:carousel-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorCarouselWidgetV1Mixin;
