...
final class GalleryWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:gallery-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorGalleryWidgetV1Mixin;
