...
final class ChannelTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:channel-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorChannelTeaserV1Mixin;
