...
final class TimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:timeline:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorTimelineV1Mixin;
