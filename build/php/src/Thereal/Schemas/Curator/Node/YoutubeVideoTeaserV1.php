...
final class YoutubeVideoTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:youtube-video-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:youtube-video-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:youtube-video-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorYoutubeVideoTeaserV1Mixin;
