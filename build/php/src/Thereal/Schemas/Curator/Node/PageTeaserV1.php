<?php
// @link https://schemas.thereal.com/json-schema/thereal/curator/node/page-teaser/1-0-0.json#
...
use Triniti\Schemas\Curator\Mixin\PageTeaser\PageTeaserV1 as TrinitiCuratorPageTeaserV1;
use Triniti\Schemas\Curator\Mixin\PageTeaser\PageTeaserV1Mixin as TrinitiCuratorPageTeaserV1Mixin;
use Triniti\Schemas\Curator\Mixin\PageTeaser\PageTeaserV1Trait as TrinitiCuratorPageTeaserV1Trait;
...
final class PageTeaserV1 extends AbstractMessage implements
    PageTeaser,
    GdbotsNcrNodeV1,
    TrinitiCuratorTeaserV1,
    TrinitiCuratorTeaserHasTargetV1,
    TrinitiCuratorPageTeaserV1,
    ...
    TrinitiTaxonomyHashtaggableV1
{
    ...
    use TrinitiCuratorPageTeaserV1Trait;
    ...
    {
        return new Schema('pbj:thereal:curator:node:page-teaser:1-0-0', __CLASS__,
            [],
            [
                GdbotsNcrNodeV1Mixin::create(),
                TrinitiCuratorTeaserV1Mixin::create(),
                TrinitiCuratorTeaserHasTargetV1Mixin::create(),
                TrinitiCuratorPageTeaserV1Mixin::create(),
