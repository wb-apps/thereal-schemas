...
final class PageTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:page-teaser:v1';
    const MIXINS = [
      ...
      'triniti:curator:mixin:page-teaser:v1',
    ...
    use TrinitiCuratorPageTeaserV1Mixin;
