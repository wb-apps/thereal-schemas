...
final class LinkTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:link-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorLinkTeaserV1Mixin;
