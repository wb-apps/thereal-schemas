...
final class AlertWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:alert-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorAlertWidgetV1Mixin;
