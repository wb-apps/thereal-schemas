<?php
// @link https://schemas.thereal.com/json-schema/thereal/curator/node/alert-widget/1-0-0.json#
    ...
    TrinitiCuratorWidgetHasSearchRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:node:alert-widget:1-0-0', __CLASS__,
            [],
            [
