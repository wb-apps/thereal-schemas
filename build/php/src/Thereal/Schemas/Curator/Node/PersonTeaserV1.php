...
final class PersonTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:person-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorPersonTeaserV1Mixin;
