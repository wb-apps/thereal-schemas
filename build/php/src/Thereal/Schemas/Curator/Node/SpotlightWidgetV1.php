...
final class SpotlightWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:spotlight-widget:v1';
    const MIXINS = [
      'gdbots:ncr:mixin:node:v1',
      'gdbots:ncr:mixin:node',
      'triniti:curator:mixin:widget:v1',
      'triniti:curator:mixin:widget',
      'triniti:curator:mixin:spotlight-widget:v1',
    ...
    use TrinitiCuratorSpotlightWidgetV1Mixin;
