...
final class TagCloudWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:tag-cloud-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:tag-cloud-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:tag-cloud-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorTagCloudWidgetV1Mixin;
