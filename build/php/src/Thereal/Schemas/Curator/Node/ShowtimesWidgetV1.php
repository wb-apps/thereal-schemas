...
final class ShowtimesWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:showtimes-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorShowtimesWidgetV1Mixin;
