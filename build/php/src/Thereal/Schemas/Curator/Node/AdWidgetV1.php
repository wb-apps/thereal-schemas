...
final class AdWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:ad-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorAdWidgetV1Mixin;
