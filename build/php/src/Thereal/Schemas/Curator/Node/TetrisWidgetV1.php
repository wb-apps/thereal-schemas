...
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:tetris-widget:v1';
    const MIXINS = [
