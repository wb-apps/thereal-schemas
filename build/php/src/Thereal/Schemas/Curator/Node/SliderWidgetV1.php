...
final class SliderWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:slider-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorSliderWidgetV1Mixin;
