...
final class BlogrollWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:blogroll-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorBlogrollWidgetV1Mixin;
