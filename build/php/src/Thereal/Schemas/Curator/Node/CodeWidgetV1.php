...
final class CodeWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:code-widget:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorCodeWidgetV1Mixin;
