...
final class TimelineTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:timeline-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorTimelineTeaserV1Mixin;
