...
use Triniti\Schemas\Curator\Mixin\AssetTeaser\AssetTeaserV1 as TrinitiCuratorAssetTeaserV1;
use Triniti\Schemas\Curator\Mixin\AssetTeaser\AssetTeaserV1Mixin as TrinitiCuratorAssetTeaserV1Mixin;
use Triniti\Schemas\Curator\Mixin\AssetTeaser\AssetTeaserV1Trait as TrinitiCuratorAssetTeaserV1Trait;
...
final class AssetTeaserV1 extends AbstractMessage implements
    AssetTeaser,
    GdbotsNcrNodeV1,
    TrinitiCuratorTeaserV1,
    TrinitiCuratorTeaserHasTargetV1,
    TrinitiCuratorAssetTeaserV1,
    ...
    TrinitiTaxonomyHashtaggableV1
{
    ...
    use TrinitiCuratorAssetTeaserV1Trait;
    ...
    {
        return new Schema('pbj:thereal:curator:node:asset-teaser:1-0-0', __CLASS__,
            [],
            [
