...
{
    const SCHEMA_ID = 'pbj:thereal:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:node:asset-teaser:v1';
    const MIXINS = [
