...
final class ExpirePromotionV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:expire-promotion:v1';
    const MIXINS = [
