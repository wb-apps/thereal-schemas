...
final class CreateTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:create-timeline:v1';
    const MIXINS = [
