...
final class MarkGalleryAsDraftV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:mark-gallery-as-draft:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:mark-gallery-as-draft';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:mark-gallery-as-draft:v1';
    const MIXINS = [
