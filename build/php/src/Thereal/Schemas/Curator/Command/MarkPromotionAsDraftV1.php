...
final class MarkPromotionAsDraftV1 extends AbstractMessage implements
    MarkPromotionAsDraft,
    GdbotsPbjxCommandV1,
    GdbotsNcrMarkNodeAsDraftV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:command:mark-promotion-as-draft:1-0-0', __CLASS__,
            [],
            [
