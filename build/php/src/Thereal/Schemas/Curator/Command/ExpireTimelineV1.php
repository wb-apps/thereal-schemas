...
final class ExpireTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:expire-timeline:v1';
    const MIXINS = [
