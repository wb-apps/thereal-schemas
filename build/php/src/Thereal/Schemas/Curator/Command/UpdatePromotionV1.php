...
final class UpdatePromotionV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:update-promotion:v1';
    const MIXINS = [
