...
final class UpdateTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:update-timeline:v1';
    const MIXINS = [
