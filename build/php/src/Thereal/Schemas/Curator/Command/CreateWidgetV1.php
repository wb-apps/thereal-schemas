...
final class CreateWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:create-widget:v1';
    const MIXINS = [
