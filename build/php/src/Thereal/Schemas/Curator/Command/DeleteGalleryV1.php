...
final class DeleteGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-gallery:v1';
    const MIXINS = [
