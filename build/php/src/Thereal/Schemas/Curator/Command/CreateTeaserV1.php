...
final class CreateTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:create-teaser:v1';
    const MIXINS = [
