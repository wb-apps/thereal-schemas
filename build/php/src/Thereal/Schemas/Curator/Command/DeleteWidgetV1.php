...
final class DeleteWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-widget:v1';
    const MIXINS = [
