...
final class DeleteTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-timeline:v1';
    const MIXINS = [
