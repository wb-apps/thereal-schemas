...
final class UnpublishTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:unpublish-timeline:v1';
    const MIXINS = [
