...
final class UnpublishPromotionV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:unpublish-promotion:v1';
    const MIXINS = [
