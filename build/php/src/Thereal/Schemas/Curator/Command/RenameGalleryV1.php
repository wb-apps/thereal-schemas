...
final class RenameGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:rename-gallery:v1';
    const MIXINS = [
