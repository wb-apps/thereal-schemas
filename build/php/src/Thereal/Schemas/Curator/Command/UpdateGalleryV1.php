...
final class UpdateGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:update-gallery:v1';
    const MIXINS = [
