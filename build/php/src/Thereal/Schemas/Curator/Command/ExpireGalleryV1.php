...
final class ExpireGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:expire-gallery:v1';
    const MIXINS = [
