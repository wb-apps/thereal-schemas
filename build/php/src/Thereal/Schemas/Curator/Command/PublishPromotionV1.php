...
final class PublishPromotionV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:publish-promotion:v1';
    const MIXINS = [
