...
final class PublishTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:publish-timeline:v1';
    const MIXINS = [
