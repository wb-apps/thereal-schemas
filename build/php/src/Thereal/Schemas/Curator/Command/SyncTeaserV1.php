...
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:sync-teaser:v1';
    const MIXINS = [
