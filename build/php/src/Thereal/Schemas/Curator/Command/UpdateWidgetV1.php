...
final class UpdateWidgetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:update-widget:v1';
    const MIXINS = [
