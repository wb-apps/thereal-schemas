...
final class MarkTimelineAsPendingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:mark-timeline-as-pending:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:mark-timeline-as-pending';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:mark-timeline-as-pending:v1';
    const MIXINS = [
