...
final class UpdateTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:update-teaser:v1';
    const MIXINS = [
