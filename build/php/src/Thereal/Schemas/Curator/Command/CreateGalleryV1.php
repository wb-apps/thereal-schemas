...
final class CreateGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:create-gallery:v1';
    const MIXINS = [
