...
final class UnpublishTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:unpublish-teaser:v1';
    const MIXINS = [
