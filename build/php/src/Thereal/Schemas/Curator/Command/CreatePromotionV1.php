...
final class CreatePromotionV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:create-promotion:v1';
    const MIXINS = [
