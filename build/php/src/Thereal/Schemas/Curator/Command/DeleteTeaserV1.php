...
final class DeleteTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-teaser:v1';
    const MIXINS = [
