...
final class UnpublishGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:unpublish-gallery:v1';
    const MIXINS = [
