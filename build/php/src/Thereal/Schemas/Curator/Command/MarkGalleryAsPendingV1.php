...
final class MarkGalleryAsPendingV1 extends AbstractMessage implements
    MarkGalleryAsPending,
    GdbotsPbjxCommandV1,
    GdbotsNcrMarkNodeAsPendingV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:command:mark-gallery-as-pending:1-0-0', __CLASS__,
            [],
            [
