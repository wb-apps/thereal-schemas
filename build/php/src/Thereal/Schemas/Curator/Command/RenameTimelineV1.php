...
final class RenameTimelineV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:rename-timeline:v1';
    const MIXINS = [
