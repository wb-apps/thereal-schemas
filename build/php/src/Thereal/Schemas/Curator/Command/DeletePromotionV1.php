...
final class DeletePromotionV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:delete-promotion:v1';
    const MIXINS = [
