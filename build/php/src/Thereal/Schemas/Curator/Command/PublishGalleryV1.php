...
final class PublishGalleryV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:publish-gallery:v1';
    const MIXINS = [
