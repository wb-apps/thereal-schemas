...
final class PublishTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:publish-teaser:v1';
    const MIXINS = [
