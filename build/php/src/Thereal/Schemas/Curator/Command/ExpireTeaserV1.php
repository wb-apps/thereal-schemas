...
final class ExpireTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:command:expire-teaser:v1';
    const MIXINS = [
