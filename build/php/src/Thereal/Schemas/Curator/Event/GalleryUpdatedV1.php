...
final class GalleryUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-updated:v1';
    const MIXINS = [
