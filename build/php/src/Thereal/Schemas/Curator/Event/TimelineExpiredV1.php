...
final class TimelineExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-expired:v1';
    const MIXINS = [
