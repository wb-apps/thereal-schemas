...
final class PromotionMarkedAsDraftV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-marked-as-draft:v1';
    const MIXINS = [
