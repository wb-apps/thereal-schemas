...
final class TeaserPublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-published:v1';
    const MIXINS = [
