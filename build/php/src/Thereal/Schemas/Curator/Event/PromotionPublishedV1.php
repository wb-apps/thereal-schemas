...
final class PromotionPublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-published:v1';
    const MIXINS = [
