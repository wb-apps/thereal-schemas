...
final class TeaserCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-created:v1';
    const MIXINS = [
