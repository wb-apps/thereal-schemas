...
final class WidgetCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:widget-created:v1';
    const MIXINS = [
