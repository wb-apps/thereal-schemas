...
final class GalleryRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-renamed:v1';
    const MIXINS = [
