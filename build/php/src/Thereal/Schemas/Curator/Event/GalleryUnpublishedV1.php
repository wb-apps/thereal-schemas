...
final class GalleryUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-unpublished:v1';
    const MIXINS = [
