...
final class WidgetUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:widget-updated:v1';
    const MIXINS = [
