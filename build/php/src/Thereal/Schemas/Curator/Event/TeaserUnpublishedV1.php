...
final class TeaserUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-unpublished:v1';
    const MIXINS = [
