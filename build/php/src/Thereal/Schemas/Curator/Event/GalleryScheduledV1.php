...
final class GalleryScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-scheduled:v1';
    const MIXINS = [
