...
final class TimelineScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-scheduled:v1';
    const MIXINS = [
