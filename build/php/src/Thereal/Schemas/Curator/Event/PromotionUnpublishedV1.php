...
final class PromotionUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-unpublished:v1';
    const MIXINS = [
