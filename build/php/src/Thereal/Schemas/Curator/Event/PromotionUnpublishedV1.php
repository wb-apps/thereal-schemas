...
final class PromotionUnpublishedV1 extends AbstractMessage implements
    ...
    GdbotsEnrichmentsTimeSamplingV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:event:promotion-unpublished:1-0-0', __CLASS__,
            [],
            [
