...
final class PromotionUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-updated:v1';
    const MIXINS = [
