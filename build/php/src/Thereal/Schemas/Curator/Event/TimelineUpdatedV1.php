...
final class TimelineUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-updated:v1';
    const MIXINS = [
