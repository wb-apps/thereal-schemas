...
final class GalleryCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-created:v1';
    const MIXINS = [
