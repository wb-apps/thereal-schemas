...
final class TimelineDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-deleted:v1';
    const MIXINS = [
