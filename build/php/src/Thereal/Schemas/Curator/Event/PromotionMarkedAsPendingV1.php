...
final class PromotionMarkedAsPendingV1 extends AbstractMessage implements
    PromotionMarkedAsPending,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeMarkedAsPendingV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:event:promotion-marked-as-pending:1-0-0', __CLASS__,
            [],
            [
