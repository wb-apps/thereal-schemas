...
final class TeaserExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-expired:v1';
    const MIXINS = [
