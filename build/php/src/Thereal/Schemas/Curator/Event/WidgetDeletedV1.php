...
final class WidgetDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:widget-deleted:v1';
    const MIXINS = [
