...
final class PromotionScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-scheduled:v1';
    const MIXINS = [
