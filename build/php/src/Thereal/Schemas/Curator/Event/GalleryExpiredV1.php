...
final class GalleryExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-expired:v1';
    const MIXINS = [
