...
final class PromotionExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-expired:v1';
    const MIXINS = [
