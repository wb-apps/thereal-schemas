...
final class TeaserScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-scheduled:v1';
    const MIXINS = [
