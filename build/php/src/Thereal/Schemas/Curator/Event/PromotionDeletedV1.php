...
final class PromotionDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-deleted:v1';
    const MIXINS = [
