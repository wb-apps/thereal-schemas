...
final class GalleryPublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-published:v1';
    const MIXINS = [
