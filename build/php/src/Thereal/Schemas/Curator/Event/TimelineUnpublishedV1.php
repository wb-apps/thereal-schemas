...
final class TimelineUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-unpublished:v1';
    const MIXINS = [
