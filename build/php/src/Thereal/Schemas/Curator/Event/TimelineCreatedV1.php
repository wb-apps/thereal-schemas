...
final class TimelineCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-created:v1';
    const MIXINS = [
