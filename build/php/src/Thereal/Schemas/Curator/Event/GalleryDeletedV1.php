...
final class GalleryDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:gallery-deleted:v1';
    const MIXINS = [
