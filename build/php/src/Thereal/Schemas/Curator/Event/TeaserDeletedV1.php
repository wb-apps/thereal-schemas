...
final class TeaserDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-deleted:v1';
    const MIXINS = [
