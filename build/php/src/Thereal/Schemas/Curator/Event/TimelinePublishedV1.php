...
final class TimelinePublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-published:v1';
    const MIXINS = [
