...
final class TeaserMarkedAsDraftV1 extends AbstractMessage implements
    TeaserMarkedAsDraft,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeMarkedAsDraftV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:event:teaser-marked-as-draft:1-0-0', __CLASS__,
            [],
            [
