...
final class TeaserMarkedAsDraftV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-marked-as-draft:v1';
    const MIXINS = [
