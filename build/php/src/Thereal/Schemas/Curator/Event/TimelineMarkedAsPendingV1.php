...
final class TimelineMarkedAsPendingV1 extends AbstractMessage implements
    TimelineMarkedAsPending,
    GdbotsPbjxEventV1,
    GdbotsNcrNodeMarkedAsPendingV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:event:timeline-marked-as-pending:1-0-0', __CLASS__,
            [],
            [
