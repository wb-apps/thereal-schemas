...
final class TimelineMarkedAsPendingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-marked-as-pending:v1';
    const MIXINS = [
