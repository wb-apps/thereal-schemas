...
final class TimelineRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:timeline-renamed:v1';
    const MIXINS = [
