...
final class TeaserUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:teaser-updated:v1';
    const MIXINS = [
