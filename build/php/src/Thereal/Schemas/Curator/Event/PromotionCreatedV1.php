...
final class PromotionCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:event:promotion-created:v1';
    const MIXINS = [
