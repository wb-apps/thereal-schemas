...
final class GetPromotionResponseV1 extends AbstractMessage implements
    ...
    GdbotsNcrGetNodeResponseV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:request:get-promotion-response:1-0-0', __CLASS__,
            [],
            [
