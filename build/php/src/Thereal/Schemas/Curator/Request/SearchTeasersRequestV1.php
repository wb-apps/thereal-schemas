...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:search-teasers-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:search-teasers-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:search-teasers-request:v1';
    const MIXINS = [
