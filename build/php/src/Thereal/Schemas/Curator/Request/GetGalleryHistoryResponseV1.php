...
final class GetGalleryHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-gallery-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-gallery-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-gallery-history-response:v1';
    const MIXINS = [
