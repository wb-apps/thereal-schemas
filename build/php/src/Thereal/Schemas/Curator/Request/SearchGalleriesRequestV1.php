...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:search-galleries-request:v1';
    const MIXINS = [
