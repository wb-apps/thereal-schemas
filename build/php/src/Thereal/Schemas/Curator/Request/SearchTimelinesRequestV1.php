...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:search-timelines-request:v1';
    const MIXINS = [
