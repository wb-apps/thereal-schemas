...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:render-widget-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:render-widget-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:render-widget-request:v1';
    const MIXINS = [
