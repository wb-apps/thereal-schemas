...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:search-widgets-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:search-widgets-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:search-widgets-response:v1';
    const MIXINS = [
