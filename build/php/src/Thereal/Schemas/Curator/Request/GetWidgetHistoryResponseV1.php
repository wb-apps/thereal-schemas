...
final class GetWidgetHistoryResponseV1 extends AbstractMessage implements
    GetWidgetHistoryResponse,
    ...
    GdbotsPbjxGetEventsResponseV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:request:get-widget-history-response:1-0-0', __CLASS__,
            [],
            [
