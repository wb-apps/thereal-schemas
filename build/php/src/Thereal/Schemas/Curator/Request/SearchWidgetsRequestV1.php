...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:search-widgets-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:search-widgets-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:search-widgets-request:v1';
    const MIXINS = [
