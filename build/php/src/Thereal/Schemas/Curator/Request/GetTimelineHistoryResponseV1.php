...
final class GetTimelineHistoryResponseV1 extends AbstractMessage implements
    GetTimelineHistoryResponse,
    ...
    GdbotsPbjxGetEventsResponseV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:request:get-timeline-history-response:1-0-0', __CLASS__,
            [],
            [
