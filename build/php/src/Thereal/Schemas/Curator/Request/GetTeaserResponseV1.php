...
final class GetTeaserResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-teaser-response:v1';
    const MIXINS = [
