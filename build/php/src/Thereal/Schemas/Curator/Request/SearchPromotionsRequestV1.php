...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:search-promotions-request:v1';
    const MIXINS = [
