...
final class GetWidgetHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-widget-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-widget-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-widget-history-request:v1';
    const MIXINS = [
