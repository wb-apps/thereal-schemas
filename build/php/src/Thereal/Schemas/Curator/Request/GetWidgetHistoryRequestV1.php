...
final class GetWidgetHistoryRequestV1 extends AbstractMessage implements
    GetWidgetHistoryRequest,
    GdbotsPbjxRequestV1,
    GdbotsPbjxGetEventsRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:request:get-widget-history-request:1-0-0', __CLASS__,
            [],
            [
