...
final class GetTimelineRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-timeline-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-timeline-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-timeline-request:v1';
    const MIXINS = [
