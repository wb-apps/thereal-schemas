...
final class GetPromotionRequestV1 extends AbstractMessage implements
    GetPromotionRequest,
    GdbotsPbjxRequestV1,
    GdbotsNcrGetNodeRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:request:get-promotion-request:1-0-0', __CLASS__,
            [],
            [
