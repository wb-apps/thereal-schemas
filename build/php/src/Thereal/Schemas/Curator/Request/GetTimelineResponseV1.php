...
final class GetTimelineResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-timeline-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-timeline-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-timeline-response:v1';
    const MIXINS = [
