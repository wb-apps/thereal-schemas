...
final class GetGalleryHistoryRequestV1 extends AbstractMessage implements
    GetGalleryHistoryRequest,
    GdbotsPbjxRequestV1,
    GdbotsPbjxGetEventsRequestV1
{
    ...
    {
        return new Schema('pbj:thereal:curator:request:get-gallery-history-request:1-0-0', __CLASS__,
            [],
            [
