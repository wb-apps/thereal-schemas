...
final class GetWidgetRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-widget-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-widget-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-widget-request:v1';
    const MIXINS = [
