...
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:render-widget-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:render-widget-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:render-widget-response:v1';
    const MIXINS = [
