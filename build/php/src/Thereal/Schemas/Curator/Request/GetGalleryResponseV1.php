...
final class GetGalleryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:curator:request:get-gallery-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:curator:request:get-gallery-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:curator:request:get-gallery-response:v1';
    const MIXINS = [
