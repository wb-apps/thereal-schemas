...
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:document-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:document-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:document-asset:v1';
    const MIXINS = [
