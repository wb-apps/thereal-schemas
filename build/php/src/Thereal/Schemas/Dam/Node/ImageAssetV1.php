...
final class ImageAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:image-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:image-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:image-asset:v1';
    const MIXINS = [
    ...
    use TrinitiDamImageAssetV1Mixin;
