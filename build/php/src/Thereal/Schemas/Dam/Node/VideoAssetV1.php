...
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:video-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:video-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:video-asset:v1';
    const MIXINS = [
    ...
    use TrinitiDamVideoAssetV1Mixin;
