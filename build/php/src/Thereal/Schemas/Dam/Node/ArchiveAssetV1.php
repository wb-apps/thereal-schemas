...
final class ArchiveAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:archive-asset:v1';
    const MIXINS = [
    ...
    use TrinitiDamArchiveAssetV1Mixin;
