...
final class AudioAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:audio-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:audio-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:audio-asset:v1';
    const MIXINS = [
    ...
    use TrinitiDamAudioAssetV1Mixin;
