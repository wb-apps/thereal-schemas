...
final class CodeAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:code-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:code-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:code-asset:v1';
    const MIXINS = [
    ...
    use TrinitiDamCodeAssetV1Mixin;
