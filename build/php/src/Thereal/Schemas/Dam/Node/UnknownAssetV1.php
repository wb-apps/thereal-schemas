...
final class UnknownAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:node:unknown-asset:v1';
    const MIXINS = [
    ...
    use TrinitiDamUnknownAssetV1Mixin;
