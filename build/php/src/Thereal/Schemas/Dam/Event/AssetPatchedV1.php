...
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-patched:v1';
    const MIXINS = [
