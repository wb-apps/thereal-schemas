...
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-unlinked:v1';
    const MIXINS = [
