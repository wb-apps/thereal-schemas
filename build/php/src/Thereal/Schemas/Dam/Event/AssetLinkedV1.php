...
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-linked:v1';
    const MIXINS = [
