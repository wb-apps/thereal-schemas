...
final class AssetExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-expired:v1';
    const MIXINS = [
