...
final class AssetCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-created:v1';
    const MIXINS = [
