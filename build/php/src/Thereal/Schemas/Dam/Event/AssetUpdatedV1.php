...
final class AssetUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-updated:v1';
    const MIXINS = [
