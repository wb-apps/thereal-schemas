...
final class AssetDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:event:asset-deleted:v1';
    const MIXINS = [
