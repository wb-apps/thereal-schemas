...
final class ExpireAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:expire-asset:v1';
    const MIXINS = [
