...
final class CreateAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:create-asset:v1';
    const MIXINS = [
