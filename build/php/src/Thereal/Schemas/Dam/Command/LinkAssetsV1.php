...
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:link-assets:v1';
    const MIXINS = [
