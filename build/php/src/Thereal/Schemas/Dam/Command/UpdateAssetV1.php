...
final class UpdateAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:update-asset:v1';
    const MIXINS = [
