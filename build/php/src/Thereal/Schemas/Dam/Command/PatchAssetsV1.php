...
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:patch-assets:v1';
    const MIXINS = [
