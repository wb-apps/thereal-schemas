...
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:unlink-assets:v1';
    const MIXINS = [
