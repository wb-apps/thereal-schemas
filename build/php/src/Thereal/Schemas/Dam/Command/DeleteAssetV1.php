...
final class DeleteAssetV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:command:delete-asset:v1';
    const MIXINS = [
