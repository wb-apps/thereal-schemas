...
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:get-upload-urls-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:get-upload-urls-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-upload-urls-request:v1';
    const MIXINS = [
