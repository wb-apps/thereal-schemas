...
final class GetAssetHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-asset-history-request:v1';
    const MIXINS = [
