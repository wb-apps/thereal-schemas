...
final class GetAssetResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:get-asset-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:get-asset-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-asset-response:v1';
    const MIXINS = [
