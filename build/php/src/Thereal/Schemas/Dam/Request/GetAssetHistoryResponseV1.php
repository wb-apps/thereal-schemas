...
final class GetAssetHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-asset-history-response:v1';
    const MIXINS = [
