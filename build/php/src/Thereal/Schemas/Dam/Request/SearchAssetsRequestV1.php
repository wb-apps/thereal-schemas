...
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:search-assets-request:v1';
    const MIXINS = [
