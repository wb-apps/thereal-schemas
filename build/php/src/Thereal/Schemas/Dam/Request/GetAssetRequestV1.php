...
final class GetAssetRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:get-asset-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:get-asset-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:get-asset-request:v1';
    const MIXINS = [
