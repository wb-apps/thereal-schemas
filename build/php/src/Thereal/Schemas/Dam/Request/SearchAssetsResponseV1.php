...
{
    const SCHEMA_ID = 'pbj:thereal:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:dam:request:search-assets-response:v1';
    const MIXINS = [
