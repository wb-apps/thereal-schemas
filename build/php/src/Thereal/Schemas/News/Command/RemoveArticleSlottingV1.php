...
{
    const SCHEMA_ID = 'pbj:thereal:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:remove-article-slotting:v1';
    const MIXINS = [
