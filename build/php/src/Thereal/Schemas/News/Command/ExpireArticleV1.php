...
final class ExpireArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:expire-article:v1';
    const MIXINS = [
