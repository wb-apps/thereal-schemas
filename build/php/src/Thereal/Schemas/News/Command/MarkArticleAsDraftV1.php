...
final class MarkArticleAsDraftV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:mark-article-as-draft:v1';
    const MIXINS = [
