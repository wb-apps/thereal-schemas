...
final class DeleteArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:delete-article:v1';
    const MIXINS = [
