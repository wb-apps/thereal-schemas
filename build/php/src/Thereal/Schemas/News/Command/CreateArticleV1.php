...
final class CreateArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:create-article:v1';
    const MIXINS = [
