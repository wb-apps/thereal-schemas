...
final class MarkArticleAsPendingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:mark-article-as-pending:v1';
    const MIXINS = [
