...
final class LockArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:lock-article:v1';
    const MIXINS = [
