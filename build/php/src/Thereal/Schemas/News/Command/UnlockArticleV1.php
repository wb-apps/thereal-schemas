...
final class UnlockArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:unlock-article:v1';
    const MIXINS = [
