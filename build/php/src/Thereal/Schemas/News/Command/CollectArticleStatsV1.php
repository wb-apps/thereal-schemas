...
{
    const SCHEMA_ID = 'pbj:thereal:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:collect-article-stats:v1';
    const MIXINS = [
