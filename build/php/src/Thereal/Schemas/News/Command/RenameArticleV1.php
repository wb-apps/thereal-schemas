...
final class RenameArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:rename-article:v1';
    const MIXINS = [
