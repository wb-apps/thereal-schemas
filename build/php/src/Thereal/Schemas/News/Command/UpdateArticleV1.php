...
final class UpdateArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:update-article:v1';
    const MIXINS = [
