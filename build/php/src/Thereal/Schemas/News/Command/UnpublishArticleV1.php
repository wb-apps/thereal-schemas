...
final class UnpublishArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:unpublish-article:v1';
    const MIXINS = [
