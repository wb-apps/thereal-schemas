...
final class PublishArticleV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:command:publish-article:v1';
    const MIXINS = [
