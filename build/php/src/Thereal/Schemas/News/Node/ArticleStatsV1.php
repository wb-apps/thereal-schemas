...
{
    const SCHEMA_ID = 'pbj:thereal:news:node:article-stats:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:node:article-stats';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:node:article-stats:v1';
    const MIXINS = [
