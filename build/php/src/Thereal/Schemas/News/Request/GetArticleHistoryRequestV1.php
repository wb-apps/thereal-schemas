...
final class GetArticleHistoryRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:request:get-article-history-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:request:get-article-history-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:request:get-article-history-request:v1';
    const MIXINS = [
