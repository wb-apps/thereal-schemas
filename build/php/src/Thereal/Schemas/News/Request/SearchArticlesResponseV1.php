...
{
    const SCHEMA_ID = 'pbj:thereal:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:request:search-articles-response:v1';
    const MIXINS = [
