...
final class GetArticleResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:request:get-article-response:v1';
    const MIXINS = [
