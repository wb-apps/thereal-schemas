...
final class GetArticleRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:request:get-article-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:request:get-article-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:request:get-article-request:v1';
    const MIXINS = [
