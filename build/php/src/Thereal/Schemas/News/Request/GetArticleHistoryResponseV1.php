...
final class GetArticleHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:request:get-article-history-response:v1';
    const MIXINS = [
