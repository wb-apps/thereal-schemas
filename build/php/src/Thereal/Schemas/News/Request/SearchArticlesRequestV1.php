...
{
    const SCHEMA_ID = 'pbj:thereal:news:request:search-articles-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:request:search-articles-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:request:search-articles-request:v1';
    const MIXINS = [
