...
final class ArticleLockedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-locked:v1';
    const MIXINS = [
