...
final class ArticleRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-renamed:v1';
    const MIXINS = [
