...
final class ArticlePublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-published:v1';
    const MIXINS = [
