...
final class ArticleUnpublishedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-unpublished:v1';
    const MIXINS = [
