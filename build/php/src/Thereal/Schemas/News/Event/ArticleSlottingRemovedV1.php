...
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-slotting-removed:v1';
    const MIXINS = [
