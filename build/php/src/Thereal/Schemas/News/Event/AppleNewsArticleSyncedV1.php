...
{
    const SCHEMA_ID = 'pbj:thereal:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:apple-news-article-synced:v1';
    const MIXINS = [
