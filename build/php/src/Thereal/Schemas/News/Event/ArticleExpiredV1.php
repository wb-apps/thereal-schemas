...
final class ArticleExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-expired:v1';
    const MIXINS = [
