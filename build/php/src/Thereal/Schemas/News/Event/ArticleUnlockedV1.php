...
final class ArticleUnlockedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-unlocked:v1';
    const MIXINS = [
