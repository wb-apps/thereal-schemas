...
final class ArticleUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-updated:v1';
    const MIXINS = [
