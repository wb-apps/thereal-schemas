...
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-stats-collected:v1';
    const MIXINS = [
