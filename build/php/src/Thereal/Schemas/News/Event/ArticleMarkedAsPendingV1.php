...
final class ArticleMarkedAsPendingV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-marked-as-pending:v1';
    const MIXINS = [
