...
final class ArticleCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-created:v1';
    const MIXINS = [
