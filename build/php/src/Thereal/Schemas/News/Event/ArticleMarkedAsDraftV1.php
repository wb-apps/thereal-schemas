...
final class ArticleMarkedAsDraftV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-marked-as-draft:v1';
    const MIXINS = [
