...
final class ArticleDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-deleted:v1';
    const MIXINS = [
