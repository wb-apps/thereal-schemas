...
final class ArticleScheduledV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'thereal:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'thereal:news:event:article-scheduled:v1';
    const MIXINS = [
