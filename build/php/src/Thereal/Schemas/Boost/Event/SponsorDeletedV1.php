...
final class SponsorDeletedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:event:sponsor-deleted:v1';
    const MIXINS = [
