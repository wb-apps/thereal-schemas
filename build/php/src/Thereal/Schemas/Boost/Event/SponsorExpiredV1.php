...
final class SponsorExpiredV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:event:sponsor-expired:v1';
    const MIXINS = [
