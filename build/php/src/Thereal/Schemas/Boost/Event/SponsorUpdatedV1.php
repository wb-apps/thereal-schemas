...
final class SponsorUpdatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:event:sponsor-updated:v1';
    const MIXINS = [
