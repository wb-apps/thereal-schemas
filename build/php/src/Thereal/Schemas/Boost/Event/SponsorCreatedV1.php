...
final class SponsorCreatedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:event:sponsor-created:v1';
    const MIXINS = [
