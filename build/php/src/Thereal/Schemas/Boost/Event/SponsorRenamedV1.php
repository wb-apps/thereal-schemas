...
final class SponsorRenamedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:event:sponsor-renamed:v1';
    const MIXINS = [
