...
{
    const SCHEMA_ID = 'pbj:thereal:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:request:search-sponsors-request:v1';
    const MIXINS = [
