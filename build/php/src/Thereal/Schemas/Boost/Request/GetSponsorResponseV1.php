...
final class GetSponsorResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:request:get-sponsor-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:request:get-sponsor-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:request:get-sponsor-response:v1';
    const MIXINS = [
