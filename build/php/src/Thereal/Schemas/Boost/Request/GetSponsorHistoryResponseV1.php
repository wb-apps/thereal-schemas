...
final class GetSponsorHistoryResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:request:get-sponsor-history-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:request:get-sponsor-history-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:request:get-sponsor-history-response:v1';
    const MIXINS = [
