...
final class GetSponsorRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:request:get-sponsor-request:v1';
    const MIXINS = [
