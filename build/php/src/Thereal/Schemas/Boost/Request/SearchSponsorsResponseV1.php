...
{
    const SCHEMA_ID = 'pbj:thereal:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:request:search-sponsors-response:v1';
    const MIXINS = [
