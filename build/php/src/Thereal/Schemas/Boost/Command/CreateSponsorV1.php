...
final class CreateSponsorV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:command:create-sponsor:v1';
    const MIXINS = [
