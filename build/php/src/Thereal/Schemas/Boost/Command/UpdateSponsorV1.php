...
final class UpdateSponsorV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:command:update-sponsor:v1';
    const MIXINS = [
