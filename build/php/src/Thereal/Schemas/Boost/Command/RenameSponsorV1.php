...
final class RenameSponsorV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:command:rename-sponsor:v1';
    const MIXINS = [
