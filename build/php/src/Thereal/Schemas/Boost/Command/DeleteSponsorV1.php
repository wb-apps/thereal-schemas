...
final class DeleteSponsorV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:command:delete-sponsor:v1';
    const MIXINS = [
