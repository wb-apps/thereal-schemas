...
final class ExpireSponsorV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:command:expire-sponsor:v1';
    const MIXINS = [
