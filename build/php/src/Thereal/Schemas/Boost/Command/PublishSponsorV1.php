...
final class PublishSponsorV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:thereal:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'thereal:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'thereal:boost:command:publish-sponsor:v1';
    const MIXINS = [
